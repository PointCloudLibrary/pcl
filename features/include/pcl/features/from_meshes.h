...
inline void
computeApproximateNormals (const pcl::PointCloud<PointT>& cloud,
                           ...
                           pcl::PointCloud<PointNT>& normals)
{
  ...
  for (const auto& polygon : polygons) {
    ...
    Eigen::Vector3f vec_a_b = cloud[polygon.vertices[0]].getVector3fMap() -
 ...
 * \param[in] epsilon Optional: Epsilon for the expected noise along the surface normal
 * (default: 0.001)
 */
template <typename PointT, typename PointNT>
inline void
