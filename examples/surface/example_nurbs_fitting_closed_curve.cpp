...
pcl::visualization::PCLVisualizer
    viewer("Curve Fitting PDM (red), SDM (green), TDM (blue)");
...
main (int argc, char* argv[])
{
  ...
  // #################### CURVE FITTING #########################
  ON_NurbsCurve curve = pcl::on_nurbs::FittingCurve2dPDM::initNurbsCurve2D(
      order, data.interior, n_control_points);
