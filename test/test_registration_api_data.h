...
const int nr_correspondences_result_rej_sac = 99;
const double rej_sac_max_dist = 0.01;
const int rej_sac_max_iter = 1000;
const int correspondences_sac[99][2] = {
  { 2,  50 },
  { 16, 51 },
  { 17, 70 },
  { 18, 62 },
...
const float transform_from_SAC[4][4] = {
  { 0.97789806127548218, -0.047788232564926147, -0.20354841649532318,  0.016356263309717178 },
  { 0.045698575675487518, 0.99884331226348877,  -0.014956861734390259, 0.0023829489946365356 },
  { 0.20402772724628448,  0.0053244233131408691, 0.9789508581161499,   0.0087917596101760864 },
  { 0, 0, 0, 1 }
};
