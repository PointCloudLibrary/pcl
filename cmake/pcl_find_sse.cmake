...
function(PCL_CHECK_FOR_SSE)
  ...
  if(CMAKE_COMPILER_IS_GNUCC OR CMAKE_COMPILER_IS_GNUCXX OR CMAKE_COMPILER_IS_CLANG)
    if(SSE_LEVEL GREATER_EQUAL 1.0)
      ...
      elseif(SSE_LEVEL GREATER_EQUAL 2.0)
        list(APPEND SSE_FLAGS "-msse2")
      else()
        list(APPEND SSE_FLAGS "-msse")
      endif()
  ...
  elseif(MSVC)
    if(SSE_LEVEL GREATER_EQUAL 4.2)
      list(APPEND SSE_DEFINITIONS "-D__SSE4_2__")
    endif()
    if(SSE_LEVEL GREATER_EQUAL 4.1)
      list(APPEND SSE_DEFINITIONS "-D__SSE4_1__")
    endif()
    if(SSE_LEVEL GREATER_EQUAL 3.1)
      list(APPEND SSE_DEFINITIONS "-D__SSSE3__")
    endif()
    if(SSE_LEVEL GREATER_EQUAL 3.0)
      list(APPEND SSE_DEFINITIONS "-D__SSE3__")
    endif()
    if(SSE_LEVEL GREATER_EQUAL 2.0)
      list(APPEND SSE_DEFINITIONS "-D__SSE2__")
    endif()
    if(SSE_LEVEL GREATER_EQUAL 1.0)
      list(APPEND SSE_DEFINITIONS "-D__SSE__")
    endif()
  endif()
