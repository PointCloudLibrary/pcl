...
macro(PCL_CHECK_FOR_SSE)
    ...
    if(CMAKE_COMPILER_IS_GNUCC OR CMAKE_COMPILER_IS_GNUCXX)
       ...
       if(HAVE_SSE3_EXTENSIONS)
           SET(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS} -msse3 -mfpmath=sse")
           message(STATUS "Found SSE3 extensions, using flags: ${SSE_FLAGS}")
       elseif(HAVE_SSE2_EXTENSIONS)
           SET(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS} -msse2 -mfpmath=sse")
           message(STATUS "Found SSE2 extensions, using flags: ${SSE_FLAGS}")
       elseif(HAVE_SSE_EXTENSIONS)
           SET(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS} -msse -mfpmath=sse")
    ...
    elseif(MSVC)
        ...
        if(HAVE_SSE2_EXTENSIONS)
            SET(CMAKE_CXX_FLAGS_RELEASE "/arch:SSE2 /fp:fast -D__SSE__ -D__SSE2__")
            message(STATUS "Found SSE2 extensions, using flags: ${SSE_FLAGS}")
