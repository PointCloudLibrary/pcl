...
find_path(CMINPACK_INCLUDE_DIR cminpack.h
    HINTS ${PC_CMINPACK_INCLUDEDIR} ${PC_CMINPACK_INCLUDE_DIRS} "$ENV{PROGRAMFILES}/CMINPACK 1.1.13/include/cminpack-1")

find_library(CMINPACK_LIBRARY cminpack
    HINTS ${PC_CMINPACK_LIBDIR} ${PC_CMINPACK_LIBRARY_DIRS} "$ENV{PROGRAMFILES}/CMINPACK 1.1.13/lib")
