...
if(CMINPACK_FOUND)
  ...
  file(TO_CMAKE_PATH ${CMINPACK_LIBRARY} CMINPACK_LIBRARY_PATH)
  string(REGEX REPLACE "(.*)/[^/]+" "\\1" CMINPACK_LIBRARY_PATH "${CMINPACK_LIBRARY_PATH}")
  file(TO_CMAKE_PATH ${CMINPACK_LIBRARY_DEBUG} CMINPACK_LIBRARY_DEBUG_PATH)
  string(REGEX REPLACE "(.*)/[^/]+" "\\1" CMINPACK_LIBRARY_DEBUG_PATH "${CMINPACK_LIBRARY_DEBUG_PATH}")
  set(CMINPACK_LIB_DIRS ${CMINPACK_LIBRARY_PATH} ${CMINPACK_LIBRARY_DEBUG_PATH} 
    CACHE INTERNAL "CMINPACK_LIB_DIRS" FORCE)
  set(CMINPACK_INCLUDE_DIRS ${CMINPACK_INCLUDE_DIRS}
    CACHE INTERNAL "CMINPACK_INCLUDE_DIRS" FORCE)
