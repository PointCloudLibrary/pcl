...
if(BUILD_all_in_one_installer)
    ...
    if(CMAKE_CL_64)
        ...
        set(OPENNI_URL "http://dev.pointclouds.org/attachments/download/360/${OPENNI_PACKAGE}")
        set(OPENNI_MD5 e54b5ede27b293c579c42dcede33b289)
        set(OPENNI_SENSOR_PACKAGE "Sensor-Win-OpenSource64-5.0.3.msi")
        set(OPENNI_SENSOR_URL "http://dev.pointclouds.org/attachments/download/359/${OPENNI_SENSOR_PACKAGE}")
        set(OPENNI_SENSOR_MD5 cbf4ce02d5ef430dca17833d5588e060)
    else(CMAKE_CL_64)
        set(OPENNI_PACKAGE "OpenNI-Win32-1.3.2-Dev.msi")
        set(OPENNI_URL "http://dev.pointclouds.org/attachments/download/361/${OPENNI_PACKAGE}")
        set(OPENNI_MD5 0b7118a0581abef411b58530d4039cf0)
        set(OPENNI_SENSOR_PACKAGE "Sensor-Win-OpenSource32-5.0.3.msi")
        set(OPENNI_SENSOR_URL "http://dev.pointclouds.org/attachments/download/358/${OPENNI_SENSOR_PACKAGE}")
