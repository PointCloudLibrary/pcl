 ...
 * @author Koen Buys
 * @file tree.cpp
 * @brief This file contains the implementations for the tree building functions
 **/

// our headers
#include "libLabelSkel/blob2.h"   //this one defines the blob structure
#include "libLabelSkel/tree2.h"   //this one defines the tree structure
#include "libLabelSkel/common.h"  //this one defines the LUT's
#include "libLabelSkel/tree.h"    //this one has the prototypes for this cpp file
