...
pcl::cloud_composer::FPFHItem::FPFHItem (
    ...
    double radius)
: CloudComposerItem (std::move (name)), fpfh_ptr_ (fpfh_ptr), radius_ (radius)
...
{
  pcl::PointCloud<pcl::FPFHSignature33>::Ptr fpfh_copy (
      new pcl::PointCloud<pcl::FPFHSignature33> (*fpfh_ptr_));
