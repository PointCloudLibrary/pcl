...
#include <pcl/people/label_skeleton/tree2.h>   //this one defines the tree structure
#include <pcl/people/label_skeleton/common.h>  //this one defines the LUT's
#include <pcl/people/label_skeleton/tree.h>    //this one has the prototypes for this cpp file
