...
class OutofcoreCloud : public Object {
  ...
  //    using octree_disk =
  //    pcl::outofcore::OutofcoreOctreeBase<pcl::outofcore::OutofcoreOctreeDiskContainer<PointT>,
  //    PointT>; using octree_disk_node =
  //    pcl::outofcore::OutofcoreOctreeBaseNode<pcl::outofcore::OutofcoreOctreeDiskContainer<PointT>,
  //    PointT>;

  using OctreeDisk = pcl::outofcore::OutofcoreOctreeBase<>;
  using OctreeDiskNode = pcl::outofcore::OutofcoreOctreeBaseNode<>;
  //    using OctreeBreadthFirstIterator =
...
public:
  ...
  //    using CloudDataCacheIterator = std::map<std::string,
  //    vtkSmartPointer<vtkPolyData> >::iterator;
  ...
  increaseLodPixelThreshold ()
  {
    ...
    std::cout << "Increasing lod pixel threshold: " << lod_pixel_threshold_
              << std::endl;
  }
  ...
  decreaseLodPixelThreshold ()
  {
    ...
    std::cout << "Decreasing lod pixel threshold: " << lod_pixel_threshold_
              << std::endl;
  }
