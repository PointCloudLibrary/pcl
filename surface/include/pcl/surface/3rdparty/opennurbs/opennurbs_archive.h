...
public:
  ...
  */
  static FILE*
  Open (const wchar_t* filename, const wchar_t* mode);
  ...
  */
  static bool
  SeekFromCurrentPosition (FILE* fp, ON__INT64 offset);
  ...
  */
  static bool
  SeekFromStart (FILE* fp, ON__INT64 offset);
  ...
  */
  static bool
  SeekFromEnd (FILE* fp, ON__INT64 offset);
  ...
  */
  static bool
  Seek (FILE* fp, ON__INT64 offset, int orgin);
  ...
  */
  static ON__UINT64
  Read (FILE* fp, ON__UINT64 count, void* buffer);
  ...
  */
  static ON__UINT64
  Write (FILE* fp, ON__UINT64 count, const void* buffer);
...
public:
  ...
  */
  const wchar_t*
  FirstFile (const wchar_t* directory_name, const wchar_t* file_name_filter);

  const wchar_t*
  FirstFile (const char* directory_name, const char* file_name_filter);
  ...
  */
  bool
  CurrentFileIsHidden () const;

  bool
  GetCurrentFullPathFileName (ON_wString& filename) const;
...
private:
  ...
  char m_dirent_name_buffer[NAME_MAX +
                            1]; // < this field provide storage for m_dirent.d_name[]
...
public:
  ...
  */
  static int
  Compare (const ON_Buffer& a, const ON_Buffer& b);
  ...
  */
  ON__UINT32
  CRC32 (ON__UINT32 current_remainder) const;
  ...
  */
  ON__UINT64
  Write (ON__UINT64 size, const void* buffer);
  ...
  */
  ON__UINT64
  Read (ON__UINT64 size, void* buffer);
  ...
  */
  bool
  Seek (ON__INT64 offset, int origin);
  ...
  */
  bool
  SeekFromStart (ON__INT64 offset);
  ...
  */
  bool
  SeekFromCurrentPosition (ON__INT64 offset);
  ...
  */
  bool
  ChangeSize (ON__UINT64 buffer_size);
  ...
  */
  bool
  IsValid (const ON_TextLog* text_log) const;
  ...
  */
  ...
  void
  SetErrorHandler (ON_Buffer_ErrorHandler error_handler);
  ...
  */
  bool
  WriteToBinaryArchive (ON_BinaryArchive&) const;
  ...
  */
  bool
  ReadFromBinaryArchive (ON_BinaryArchive&);
  ...
  */
  bool
  Compress (ON_Buffer& compressed_buffer) const;
  ...
  */
  bool
  Uncompress (ON_Buffer& uncompressed_buffer) const;
...
private:
  ...
  bool
  SetCurrentSegment (bool);
  void
  Copy (const ON_Buffer&);
...
bool
ON_IsShortChunkTypecode (ON__UINT32 typecode);
...
void
ON_SetBinaryArchiveOpenNURBSVersion (ON_BinaryArchive&, int);
...
public:
  ...
  bool
  BigSeekFromStart (ON__UINT64 offset);
  bool
  BigSeekForward (ON__UINT64 offset);
  bool
  BigSeekBackward (ON__UINT64 offset);
  bool
  BigSeekFromCurrentPosition (ON__INT64 offset);
  ...
  */
  static bool
  ToggleByteOrder (int,         // number of elements
  ...
  static const char*
  TypecodeName (unsigned int tcode);

  static char*
  ON_TypecodeParse (unsigned int tcode, char* typecode_name, std::size_t max_length);

  bool
  ReadMode () const; // true if reading is permitted
  bool
  WriteMode () const; // true if writing is permitted
  ...
  */
  ON::endian
  Endian () const; // endian-ness of cpu

  int
  BadCRCCount () const; // number of chunks read with bad CRC

  bool
  ReadByte (std::size_t, void*); // must fail if mode is not read or readwrite

  bool
  WriteByte (std::size_t, const void*); // must fail if mode is not write or readwrite
  ...
  */
  ON__UINT64
  ReadBuffer (ON__UINT64 sizeof_buffer, void* buffer);
  ...
  */
  bool
  EnableCRCCalculation (bool bEnable);
  ...
  */
  bool
  ReadCompressedBufferSize (std::size_t* sizeof__outbuffer);
  ...
  */
  bool
  ReadCompressedBuffer (std::size_t sizeof__outbuffer,
                        void* outbuffer,
                        int* bFailedCRC);
  ...
  */
  bool
  WriteCompressedBuffer (std::size_t sizeof__inbuffer, const void* inbuffer);

  bool
  ReadBool (bool*);

  bool
  ReadChar (       // Read an array of 8 bit chars
      std::size_t, // number of chars to read
      char*);
  bool
  ReadChar (       // Read an array of 8 bit unsigned chars
      std::size_t, // number of unsigned chars to read
      unsigned char*);
  bool
  ReadChar ( // Read a single 8 bit char
      char*);
  bool
  ReadChar ( // Read a single 8 bit unsigned char
      unsigned char*);

  bool
  ReadShort (      // Read an array of 16 bit shorts
      std::size_t, // number of shorts to read
      short*);
  bool
  ReadShort (      // Read an array of 16 bit unsigned shorts
      std::size_t, // number of shorts to read
      unsigned short*);
  bool
  ReadShort ( // Read a single 16 bit short
      short*);
  bool
  ReadShort ( // Read a single 16 bit unsigned short
      unsigned short*);

  bool
  ReadInt (        // Read an array of 32 bit integers
  ...
  ReadInt (        // Read an array of 32 bit integers
      ...
      unsigned int*);
  bool
  ReadInt ( // Read a single 32 bit integer
      int*);
  bool
  ReadInt ( // Read a single 32 bit unsigned integer
      unsigned int*);

  bool
  ReadBigInt (     // Read an array of 64 bit integers
      std::size_t, // number of ints to read
      ON__INT64*);
  bool
  ReadBigInt (     // Read an array of 64 bit integers
      ...
      ON__UINT64*);
  bool
  ReadBigInt ( // Read a single 64 bit integer
      ON__INT64*);
  bool
  ReadBigInt ( // Read a single 64 bit unsigned integer
      ON__UINT64*);

  bool
  ReadLong (       // Read an array of 32 bit integers
      std::size_t, // number of ints to read
      long*);
  bool
  ReadLong (       // Read an array of 32 bit integers
      ...
      unsigned long*);
  bool
  ReadLong ( // Read a single 32 bit integer
      long*);
  bool
  ReadLong ( // Read a single 32 bit unsigned integer
      unsigned long*);
  bool
  ReadSize ( // Read a single std::size_t
      std::size_t*);

  bool
  ReadBigSize (std::size_t*); // 64 bits

  bool
  ReadBigTime (time_t*); // UCT seconds since 1 January 1970 (64 bits)

  bool
  ReadFloat (      // Read an array of floats
      std::size_t, // number of floats
      float*);
  bool
  ReadFloat ( // Read a single float
      float*);
  bool
  ReadDouble (     // Read an array of IEEE doubles
      std::size_t, // number of doubles
      double*);
  bool
  ReadDouble ( // Read a single double
      double*);
  ...
  bool
  ReadPoint (ON_2dPoint&);
  bool
  ReadPoint (ON_3dPoint&);
  bool
  ReadPoint (ON_4dPoint&);
  bool
  ReadVector (ON_2dVector&);
  bool
  ReadVector (ON_3dVector&);

  bool
  ReadBoundingBox (ON_BoundingBox&);

  bool
  ReadXform (ON_Xform&);

  bool
  ReadPlaneEquation (ON_PlaneEquation&);
  ...
  bool
  ReadCircle (ON_Circle&);

  bool
  ReadInterval (ON_Interval&);

  bool
  ReadUuid (ON_UUID&);

  bool
  ReadDisplayMaterialRef (ON_DisplayMaterialRef&);

  bool
  ReadLinetypeSegment (ON_LinetypeSegment&);
  ...
  */
  ON_DEPRECATED bool
  ReadStringSize (std::size_t* str_array_count);
  ...
  */
  bool
  ReadStringUTF8ElementCount (std::size_t* string_utf8_element_count);
  ...
  */
  bool
  ReadStringUTF16ElementCount (std::size_t* string_utf16_element_count);
  ...
  */
  bool
  ReadString (std::size_t str_array_count, char* str_array);
  ...
  */
  bool
  ReadString (std::size_t str_array_count, unsigned char* str_array);
  ...
  */
  bool
  ReadString (std::size_t str_array_count, unsigned short* str_array);

  bool
  ReadString (ON_String& sUTF8);

  bool
  ReadString (ON_wString& s);

  bool
  ReadComponentIndex (ON_COMPONENT_INDEX&);

  bool
  ReadArray (ON_SimpleArray<bool>&);
  bool
  ReadArray (ON_SimpleArray<char>&);
  bool
  ReadArray (ON_SimpleArray<short>&);
  bool
  ReadArray (ON_SimpleArray<int>&);
  bool
  ReadArray (ON_SimpleArray<float>&);
  bool
  ReadArray (ON_SimpleArray<double>&);
  bool
  ReadArray (ON_SimpleArray<ON_Color>&);
  bool
  ReadArray (ON_SimpleArray<ON_2dPoint>&);
  bool
  ReadArray (ON_SimpleArray<ON_3dPoint>&);
  bool
  ReadArray (ON_SimpleArray<ON_4dPoint>&);
  bool
  ReadArray (ON_SimpleArray<ON_2dVector>&);
  bool
  ReadArray (ON_SimpleArray<ON_3dVector>&);
  bool
  ReadArray (ON_SimpleArray<ON_Xform>&);
  bool
  ReadArray (ON_SimpleArray<ON_2fPoint>&);
  bool
  ReadArray (ON_SimpleArray<ON_3fPoint>&);
  bool
  ReadArray (ON_SimpleArray<ON_4fPoint>&);
  bool
  ReadArray (ON_SimpleArray<ON_2fVector>&);
  bool
  ReadArray (ON_SimpleArray<ON_3fVector>&);
  bool
  ReadArray (ON_SimpleArray<ON_UUID>&);
  bool
  ReadArray (ON_SimpleArray<ON_UuidIndex>&);
  bool
  ReadArray (ON_SimpleArray<ON_SurfaceCurvature>&);
  bool
  ReadArray (ON_ClassArray<ON_String>&);
  bool
  ReadArray (ON_ClassArray<ON_wString>&);
  bool
  ReadArray (ON_SimpleArray<ON_DisplayMaterialRef>&);
  bool
  ReadArray (ON_SimpleArray<ON_LinetypeSegment>&);
  bool
  ReadArray (ON_SimpleArray<ON_MappingChannel>&);
  bool
  ReadArray (ON_ClassArray<ON_MaterialRef>&);
  bool
  ReadArray (ON_ClassArray<ON_MappingRef>&);
  bool
  ReadArray (ON_ClassArray<class ON_ObjRef>&);
  bool
  ReadArray (ON_SimpleArray<class ON_ObjRef_IRefID>&);
  bool
  ReadArray (ON_SimpleArray<class ON_ClippingPlaneInfo>&);
  bool
  ReadArray (ON_ObjectArray<class ON_Layer>&);
  bool
  ReadArray (ON_SimpleArray<class ON_Layer*>&);

  bool
  WriteBool (bool);

  bool
  WriteChar (      // Write an array of 8 bit chars
      std::size_t, // number of chars to write
      const char*);
  bool
  WriteChar (      // Write an array of 8 bit unsigned chars
      std::size_t, // number of unsigned chars to write
      const unsigned char*);
  bool
  WriteChar ( // Write a single 8 bit char
      char);
  bool
  WriteChar ( // Write a single 8 bit unsigned char
      unsigned char);

  bool
  WriteShort (     // Write an array of 16 bit shorts
      std::size_t, // number of shorts to write
      const short*);
  bool
  WriteShort (     // Write an array of 16 bit unsigned shorts
      std::size_t, // number of shorts to write
      const unsigned short*);
  bool
  WriteShort ( // Write a single 16 bit short
      short);
  bool
  WriteShort ( // Write a single 16 bit unsigned short
      unsigned short);

  bool
  WriteInt (       // Write an array of 32 bit integers
  ...
  WriteInt (       // Write an array of 32 bit integers
      ...
      const unsigned int*);
  bool
  WriteInt ( // Write a single 32 bit integer
      int);
  bool
  WriteInt ( // Write a single 32 bit unsigned integer
      unsigned int);
  ...
  bool
  WriteLong (      // Write an array of 32 bit integers
      std::size_t, // number of ints to write
      const long*);
  bool
  WriteLong (      // Write an array of 32 bit integers
      ...
      const unsigned long*);
  bool
  WriteLong ( // Write a single 32 bit integer
      long);
  bool
  ...
  WriteFloat (     // Write a number of IEEE floats
      ...
      const float*);
  bool
  WriteFloat ( // Write a single float
      float);
  bool
  ...
  bool
  WriteColor (const ON_Color&);

  bool
  WritePoint (const ON_2dPoint&);
  bool
  WritePoint (const ON_3dPoint&);
  bool
  WritePoint (const ON_4dPoint&);
  bool
  WriteVector (const ON_2dVector&);
  bool
  WriteVector (const ON_3dVector&);

  bool
  WriteBoundingBox (const ON_BoundingBox&);

  bool
  WriteXform (const ON_Xform&);

  bool
  WritePlaneEquation (const ON_PlaneEquation&);

  bool
  WritePlane (const ON_Plane&);

  bool
  WriteLine (const ON_Line&);

  bool
  WriteArc (const ON_Arc&);

  bool
  WriteCircle (const ON_Circle&);

  bool
  WriteInterval (const ON_Interval&);

  bool
  WriteUuid (const ON_UUID&);

  bool
  WriteDisplayMaterialRef (const ON_DisplayMaterialRef&);

  bool
  WriteLinetypeSegment (const ON_LinetypeSegment&);

  // All times are stored in universal coordinated time
  // ( a.k.a GMT, UCT ).  Use ANSI C time() and gmtime() calls.
  bool
  WriteTime (const struct tm&);
  ...
  */
  bool
  WriteString (const unsigned char* sUTF8);
  ...
  */
  bool
  WriteString (const unsigned short* sUTF16);

  bool
  WriteString (const ON_String& sUTF8);

  bool
  WriteString (const ON_wString& s);

  bool
  WriteComponentIndex (const ON_COMPONENT_INDEX&);

  bool
  WriteArray (const ON_SimpleArray<bool>&);
  bool
  WriteArray (const ON_SimpleArray<char>&);
  bool
  WriteArray (const ON_SimpleArray<short>&);
  bool
  WriteArray (const ON_SimpleArray<int>&);
  bool
  WriteArray (const ON_SimpleArray<float>&);
  bool
  WriteArray (const ON_SimpleArray<double>&);

  bool
  WriteArray (const ON_SimpleArray<ON_Color>&);

  bool
  WriteArray (const ON_SimpleArray<ON_2dPoint>&);
  bool
  WriteArray (const ON_SimpleArray<ON_3dPoint>&);
  bool
  WriteArray (const ON_SimpleArray<ON_4dPoint>&);
  bool
  WriteArray (const ON_SimpleArray<ON_2dVector>&);
  bool
  WriteArray (const ON_SimpleArray<ON_3dVector>&);

  bool
  WriteArray (const ON_SimpleArray<ON_2fPoint>&);
  bool
  WriteArray (const ON_SimpleArray<ON_3fPoint>&);
  bool
  WriteArray (const ON_SimpleArray<ON_4fPoint>&);
  bool
  WriteArray (const ON_SimpleArray<ON_2fVector>&);
  bool
  WriteArray (const ON_SimpleArray<ON_3fVector>&);
  bool
  WriteArray (const ON_SimpleArray<ON_Xform>&);
  bool
  WriteArray (const ON_SimpleArray<ON_UUID>&);
  bool
  WriteArray (const ON_SimpleArray<ON_UuidIndex>&);
  bool
  WriteArray (const ON_SimpleArray<ON_SurfaceCurvature>&);
  bool
  WriteArray (const ON_ClassArray<ON_String>&);
  bool
  WriteArray (const ON_ClassArray<ON_wString>&);
  bool
  WriteArray (const ON_SimpleArray<ON_DisplayMaterialRef>&);
  bool
  WriteArray (const ON_SimpleArray<ON_LinetypeSegment>&);
  bool
  WriteArray (const ON_SimpleArray<ON_MappingChannel>&);
  bool
  WriteArray (const ON_ClassArray<ON_MaterialRef>&);
  bool
  WriteArray (const ON_ClassArray<ON_MappingRef>&);
  bool
  WriteArray (const ON_ClassArray<class ON_ObjRef>&);
  bool
  WriteArray (const ON_SimpleArray<class ON_ObjRef_IRefID>&);
  bool
  WriteArray (const ON_SimpleArray<class ON_ClippingPlaneInfo>&);
  bool
  WriteArray (int count, const class ON_Layer*);
  bool
  WriteArray (int count, const class ON_Layer* const*);
  ...
  */
  int
  ReadObject (ON_Object& object);

  bool
  WriteObject (const ON_Object*); // writes object definition
  bool
  WriteObject (const ON_Object&); // writes object definition
  ...
  */
  bool
  Write3dmStartSection (int version, const char* sStartSectionComment);
  ...
  */
  bool
  Read3dmStartSection (int* version, ON_String& sStartSectionComment);

  ///////////////////////////////////////////////////////////////////
  // Step 2: REQUIRED - Write/Read properties table
  //
  bool
  Write3dmProperties (const ON_3dmProperties&);
  bool
  Read3dmProperties (ON_3dmProperties&);

  ///////////////////////////////////////////////////////////////////
  // Step 3: REQUIRED - Write/Read settings table
  //
  bool
  Write3dmSettings (const ON_3dmSettings&);
  bool
  Read3dmSettings (ON_3dmSettings&);
  ...
  bool
  Write3dmBitmap (const ON_Bitmap&);
  bool
  ...
  int
  Read3dmBitmap ( // returns 0 at end of light table
  ...
  bool
  Write3dmTextureMapping (const ON_TextureMapping&);
  bool
  ...
  int
  Read3dmTextureMapping ( // returns 0 at end of table
  ...
  bool
  Write3dmMaterial (const ON_Material&);
  bool
  ...
  int
  Read3dmMaterial ( // returns 0 at end of table
  ...
  bool
  Write3dmLinetype (const ON_Linetype&);
  bool
  ...
  int
  Read3dmLayer ( // returns 0 at end of table
  ...
  bool
  Write3dmDimStyle (const ON_DimStyle&);
  bool
  ...
  //
  int
  Read3dmDimStyle (ON_DimStyle** // ppDimStyle
  );
  ...
  int
  Read3dmLight (              // returns 0 at end of light table
  ...
  bool
  Write3dmHatchPattern (const ON_HatchPattern&);
  bool
  ...
  int
  Read3dmHatchPattern (ON_HatchPattern**);
  bool
  ...
  bool
  Write3dmInstanceDefinition (const ON_InstanceDefinition&);
  bool
  ...
  */
  int
  Read3dmInstanceDefinition (ON_InstanceDefinition** // ppInstanceDefinition
  );
  ...
  bool
  Write3dmObject (const ON_Object&,
                  const ON_3dmObjectAttributes* // optional
  );
  bool
  ...
  int
  Read3dmObject (  // returns 0 at end of object table
                   //         1 if object is read
  ...
  bool
  Write3dmHistoryRecord (const class ON_HistoryRecord&);
  bool
  ...
  */
  int
  Read3dmHistoryRecord (class ON_HistoryRecord*&);
  bool
  ...
  */
  ...
  // opennurbs_version )
  ON_DEPRECATED bool
  BeginWrite3dmUserTable (const ON_UUID&);

  // OBSOLETE - use Write3dmAnonymousUserTableRecord(plugin_id, ..., goo)
  ON_DEPRECATED bool
  Write3dmAnonymousUserTable (const ON_3dmGoo&);
  ...
  */
  ...
  // OBSOLETE - use BeginRead3dmUserTable( plugin_id, bLastSavedAsGoo,
  // archive_3dm_version, ... )
  ON_DEPRECATED bool
  BeginRead3dmUserTable (ON_UUID&);

  // OBSOLETE - use Read3dmAnonymousUserTable( archive_3dm_version,
  // archive_opennurbs_version, goo )
  ON_DEPRECATED bool
  Read3dmAnonymousUserTable (ON_3dmGoo&);
  ...
  bool
  Read3dmEndMark (std::size_t* // sizeof_archive
  );
  ...
  //   true if write was successful.
  bool
  BeginWrite3dmChunk (unsigned int, // typecode
                      int           // value
  );

  bool
  BeginWrite3dmBigChunk (ON__UINT32 typecode, ON__INT64 value);
  ...
  */
  bool
  BeginWrite3dmChunk (unsigned int tcode, int major_version, int minor_version);
  ...
  bool
  Write3dmGoo (const ON_3dmGoo&); // call to write "goo"

  // OBSOLETE - Use BeginRead3dmBigChunk()
  ON_DEPRECATED bool
  BeginRead3dmChunk (unsigned int*, // typecode from opennurbs_3dm.h
                     int*           // value
  );
  ...
  bool
  BeginRead3dmBigChunk (unsigned int*, // typecode from opennurbs_3dm.h
                        ON__INT64*     // value
  );
  /*
  Description:
  ...
  */
  ...
  EndRead3dmChunk ();
  bool
  EndRead3dmChunk (bool bSupressPartiallyReadChunkWarning);
  ...
  */
  bool
  BeginWriteDictionaryEntry (int de_type, const wchar_t* entry_name);
  bool
  EndWriteDictionaryEntry ();
  ...
  */
  int
  BeginReadDictionaryEntry (int* de_type, ON_wString& entry_name);
  bool
  EndReadDictionaryEntry ();

  bool
  Read3dmGoo (ON_3dmGoo&); // Call to read "goo"

  // OBSOLETE - Use PeekAt3dmBigChunkType()
  ON_DEPRECATED bool
  PeekAt3dmChunkType ( // does not change file position
  ...
  // in some other way.
  bool
  Write3dmChunkVersion (int, // major // 0 to 15
                        int  // minor // 0 to 16
  );
  bool
  Read3dmChunkVersion (int*, // major // 0 to 15
                       int*  // minor // 0 to 16
  );
  ...
  */
  bool
  WriteObjectUserData (const ON_Object& object);
  ...
  */
  bool
  ReadObjectUserData (ON_Object& object);
  ...
  */
  int
  GetCurrentChunk (ON_3DM_CHUNK& chunk) const;
  int
  GetCurrentChunk (ON_3DM_BIG_CHUNK& big_chunk) const;
  ...
  */
  unsigned int
  Dump3dmChunk (ON_TextLog& text_log, int recursion_depth = 0);
...
protected:
  ...
  */
  virtual int
  LoadUserDataApplication (ON_UUID /*application_id*/
  )
  {
    return 0;
  }
  ...
  bool
  SetArchive3dmVersion (int);

private:
  // 16 bit integer IO
  bool
  WriteInt8 (std::size_t, const ON__INT8*);
  bool
  ReadInt8 (std::size_t, ON__INT8*);

  // 16 bit integer IO
  bool
  WriteInt16 (std::size_t, const ON__INT16*);
  bool
  ReadInt16 (std::size_t, ON__INT16*);

  // 32 bit integer IO
  bool
  WriteInt32 (std::size_t, const ON__INT32*);
  bool
  ReadInt32 (std::size_t, ON__INT32*);

  // 64 bit integer IO
  bool
  WriteInt64 (std::size_t, const ON__INT64*);
  bool
  ReadInt64 (std::size_t, ON__INT64*);

  bool
  BeginWrite3dmTable (unsigned int // tcode
  );
  bool
  EndWrite3dmTable (unsigned int // tcode
  );
  bool
  BeginRead3dmTable (unsigned int // tcode
  );
  bool
  EndRead3dmTable (unsigned int // tcode
  );

  bool
  Read3dmV1Layer (ON_Layer*&);
  int
  Read3dmV1Light (            // returns 0 at end of light table
                              //         1 light successfully read
                              //        -1 if file is corrupt
      ON_Light**,             // light returned here
      ON_3dmObjectAttributes* // optional - if NOT NULL, object attributes are
  ...
  int
  Read3dmV1Material (ON_Material**);
  int
  Read3dmV1Object ( // returns 0 at end of object table
                    //         1 if object is read
                    //         2 if object is skipped because it does not match filter
                    //        -1 if file is corrupt
      ON_Object**,  // object returned here (NULL if skipped)
  ...
  bool
  Read3dmV1AttributesOrMaterial (ON_3dmObjectAttributes*,   // attributes,
  ...
  bool
  Read3dmV1String (ON_String&);
  int
  Read3dmV1LayerIndex (const char*) const;

public:
  // helpers for reading V1 objects
  bool
  ReadV1_TCODE_RH_POINT (ON_Object**, ON_3dmObjectAttributes*);
  bool
  ReadV1_TCODE_MESH_OBJECT (ON_Object**, ON_3dmObjectAttributes*);
  bool
  ReadV1_TCODE_LEGACY_CRV (ON_Object**, ON_3dmObjectAttributes*);
  bool
  ReadV1_TCODE_LEGACY_FAC (ON_Object**, ON_3dmObjectAttributes*);
  bool
  ReadV1_TCODE_LEGACY_SHL (ON_Object**, ON_3dmObjectAttributes*);
  bool
  ReadV1_TCODE_RHINOIO_OBJECT_NURBS_CURVE (ON_Object**, ON_3dmObjectAttributes*);
  bool
  ReadV1_TCODE_RHINOIO_OBJECT_NURBS_SURFACE (ON_Object**, ON_3dmObjectAttributes*);
  bool
  ReadV1_TCODE_RHINOIO_OBJECT_BREP (ON_Object**, ON_3dmObjectAttributes*);
  bool
  ReadV1_TCODE_ANNOTATION (unsigned int, ON_Object**, ON_3dmObjectAttributes*);

private:
  ON::archive_mode
  Mode () const; // current read/write mode
  void
  UpdateCRC (std::size_t, const void*);
  int
  ReadObjectHelper (ON_Object**);
...
protected:
  ...
  */
  bool
  MaskReadError (ON__UINT64 sizeof_request, ON__UINT64 sizeof_read) const;
...
private:
  ...
  table_type
  TableTypeFromTypecode (unsigned int); // table type from tcode
  ...
  bool
  ReadObjectUserDataAnonymousChunk (const ON__UINT64 length_TCODE_ANONYMOUS_CHUNK,
...
private:
  ...
  struct {
    ON::archive_mode
        mode; // ON::read = read and inflate,  ON::write = deflate and write
  ...
  std::size_t
  WriteDeflate (std::size_t, // sizeof uncompressed input data
                const void*  // uncompressed input data
  );
  bool
  ReadInflate (std::size_t, // sizeof uncompressed input data
...
private:
  ...
  bool m_bEmbedTextureBitmaps; // true to embed texture, bump, trace, and wallpaper
                               // bitmaps (increases file size)
  bool m_bSaveRenderMeshes;    // true to save meshes used to render B-rep objects
                               // (increases file size)
  bool m_bSaveAnalysisMeshes; // true to save meshes used in surface analysis (increases
                              // file size)
...
public:
  ...
  */
  ...
  // of 10 to 100.
  void
  EnableMemoryBuffer (int = 16384 // capacity of memory buffer
  );

protected:
  std::size_t
  Read (std::size_t, void*);
  std::size_t
  Write (std::size_t, const void*);
  bool
  Flush ();
...
protected:
  // ON_BinaryArchive overrides
  std::size_t
  Read (std::size_t, void*); // return actual number of bytes read (like fread())
  std::size_t
  Write (std::size_t, const void*);
  bool
  Flush ();
...
protected:
  ...
  std::size_t
  Write (std::size_t,
         const void*); // return actual number of bytes written (like fwrite())
  bool
  Flush ();
