...
public:
  ...
  */
  bool
  Compress (std::size_t sizeof__inbuffer, // sizeof uncompressed input data
  ...
  */
  std::size_t
  SizeOfUncompressedBuffer () const;
  ...
  */
  bool
  Uncompress (         // read and uncompress
  ...
  */
  ...
  //
  bool
  CompressionInit (struct ON_CompressedBufferHelper*) const;
  bool
  CompressionEnd (struct ON_CompressedBufferHelper*) const;
  std::size_t
  DeflateHelper ( // returns number of bytes written
