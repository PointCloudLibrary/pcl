...
public:
  ...
  */
  ...
  unsigned int
  SizeOf () const; // return amount of memory used by user data
  ON_BOOL32
...
public:
  ...
  */
  int
  SetUserStrings (int count, const ON_UserString* us, bool bReplace);
...
public:
  ...
  */
  bool
  MoveUserDataFrom (const ON_Object& source_object);
  ...
  */
  bool
  MoveUserDataTo (const ON_Object& source_object, bool bAppend);
