...
public:
  ...
  ON_BOOL32
  Create (const ON_Plane& major__plane, double major__radius, double minor__radius);
  ON_BOOL32
  Create (const ON_Circle& major__circle, double minor__radius);
  ...
  */
  ON_Circle
  MajorCircleRadians (double minor_angle_radians) const;
  ...
  */
  ON_Circle
  MajorCircleDegrees (double minor_angle_degrees) const;
  ...
  */
  ON_Circle
  MinorCircleRadians (double major_angle_radians) const;
  ...
  */
  ON_Circle
  MinorCircleDegrees (double major_angle_degrees) const;
  ...
  ON_3dPoint
  PointAt (double major_angle_radians, double minor_angle_radians) const;

  ON_3dVector
  NormalAt (double major_angle_radians, double minor_angle_radians) const;
  ...
  // parameterization of NURBS surface does not match torus's transcendental
  // paramaterization
  int
