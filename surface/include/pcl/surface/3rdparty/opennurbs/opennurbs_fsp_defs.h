...
template <class T>
ON_SimpleFixedSizePool<T>::ON_SimpleFixedSizePool() : ON_FixedSizePool()
{}
...
template <class T>
std::size_t
ON_SimpleFixedSizePool<T>::SizeofElement() const
{
...
template <class T>
std::size_t
ON_SimpleFixedSizePool<T>::ActiveElementCount() const
{
...
template <class T>
std::size_t
ON_SimpleFixedSizePool<T>::TotalElementCount() const
{
