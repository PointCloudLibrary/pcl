...
public:
  ...
  */
  static double
  Tolerance (double relative_tolerance, double actual_size);
  ...
  */
  static double
  MinEdgeLength (double max_edge_length, double tolerance);
  ...
  */
  void
  Set (double density, double min_edge_length = 0.0001);
  ...
  */
  ...
  int
  Compare (const ON_MeshParameters&) const;
  ...
  */
  int
  CompareGeometrySettings (const ON_MeshParameters&) const;
...
public:
  ...
  */
  bool
  IsValid (int mesh_vertex_count) const;
  bool
  IsValid (int mesh_vertex_count, const ON_3fPoint* V) const;
  bool
  IsValid (int mesh_vertex_count, const ON_3dPoint* V) const;
  ...
  */
  bool
  Repair (int mesh_vertex_count);
  bool
  Repair (int mesh_vertex_count, const ON_3fPoint* V);
  bool
  Repair (int mesh_vertex_count, const ON_3dPoint* V);
  ...
  */
  bool
  ComputeFaceNormal (const ON_3dPoint* dV, ON_3dVector& FN) const;
  bool
  ComputeFaceNormal (const ON_3fPoint* fV, ON_3dVector& FN) const;
};
...
struct ON_MeshFaceSide {
  ...
  unsigned char
      side; // edge connects mesh m_V[m_F[fi].vi[side]] and m_V[m_F[fi].vi[(side+1)%4]]
  unsigned char dir; // 0 = counterclockwise, 1 = clockwise (reversed)
  unsigned short
      value; // Set to zero by ON_Mesh::GetFaceSideList(). Can be used as needed.
};
...
public:
  ...
  */
  ...
  VertexRef (ON_COMPONENT_INDEX ci) const;

  class ON_MeshVertexRef
  VertexRef (int topv_index) const;
  ...
  */
  ...
  EdgeRef (ON_COMPONENT_INDEX ci) const;

  class ON_MeshEdgeRef
  EdgeRef (int tope_index) const;
  ...
  */
  ...
  FaceRef (ON_COMPONENT_INDEX ci) const;

  class ON_MeshFaceRef
  FaceRef (int topf_index) const;
  ...
  */
  ON_3fPoint
  TopVertexPoint (int topv_index) const;
  ...
  */
  ON_Line
  TopEdgeLine (int tope_index) const;
  ...
  */
  bool
  SortVertexEdges (int topvi) const;
  ...
  */
  bool
  TopVertexIsHidden (int topvi) const;
  ...
  */
  bool
  TopEdgeIsHidden (int topei) const;
  ...
  */
  bool
  TopFaceIsHidden (int topfi) const;
...
private:
  ...
  volatile int
      m_b32IsValid; // sizeof(m_bIsValid) must be 4 - it is used in sleep locks.
                    //    0: Not Valid
                    //    1: Valid
                    //   -1: Sleep locked - ON_Mesh::Topology() calculation is in
                    //   progress
  int
  WaitUntilReady (int sleep_value) const; // waits until m_b32IsValid >= 0
...
public:
  ...
  */
  bool
  AddNgon (int N, const int* vi, const int* fi);
  struct ON_MeshNgon*
  AddNgon (int N);
  ...
  */
  bool
  ReserveNgonCapacity (int capacity);
...
public:
  ...
  void
  Set (const ON_TextureMapping& mapping);
  ...
  */
  bool
  IsDefaultSurfaceParameterMapping () const;
...
public:
  ...
  Destroy ();
  void
  EmergencyDestroy (); // Call only when memory used by this class's
  ...
  void
  DestroyTree (bool bDeleteTree = true);
  ...
  */
  ...
  bool
  SetVertexNormal (int,               // vertex index
  ...
  */
  ...
  ON_MeshVertexRef
  VertexRef (int mesh_V_index) const;
  ...
  */
  ...
  ON_MeshFaceRef
  FaceRef (int mesh_F_index) const;
  ...
  */
  ON_Geometry*
  MeshComponent (ON_COMPONENT_INDEX ci) const;
  ...
  FaceCount () const;
  int
  QuadCount () const; // number of faces that are quads
  int
  TriangleCount () const; // number of faces that are triangles
  int
  InvalidFaceCount () const; // number of face that have invalid m_vi[] values.
  bool
  HasVertexNormals () const; // normals at vertices
  bool
  HasFaceNormals () const;
  bool
  HasTextureCoordinates () const;
  bool
  HasSurfaceParameters () const;
  bool
  HasPrincipalCurvatures () const;
  bool
  ...
  */
  int
  HiddenVertexCount () const;

  bool
  GetCurvatureStats (ON::curvature_style, ON_MeshCurvatureStats&) const;

  void
  InvalidateVertexBoundingBox (); // Call if defining geometry is changed by
                                  // directly manipulating the m_V[] array.
  void
  InvalidateVertexNormalBoundingBox (); // Call if defining geometry is changed by
                                        // directly manipulating the m_N[] array.
  void
  InvalidateTextureCoordinateBoundingBox (); // Call if defining geometry is changed by
                                             // directly manipulating the m_T[] array.
  void
  InvalidateCurvatureStats (); // Call if defining geometry is changed by
                               // directly manipulating the m_T[] array.
  void
  InvalidateBoundingBoxes (); // Invalidates all cached bounding box information.

  void
  Flip (); // reverses face orientations and flips vertex and face normals

  void
  FlipVertexNormals (); // reverses vertex normals
  void
  FlipFaceNormals (); // reverses face normals
  void
  FlipFaceOrientation (); // reverses face orientation (does nothing to normals)

  void
  SetMeshParameters (const ON_MeshParameters&);
  const ON_MeshParameters*
  MeshParameters () const;
  void
  ...
  */
  bool
  ConvertTrianglesToQuads (double angle_tol_radians, double min_diagonal_length_ratio);

  bool
  ComputeFaceNormals (); // compute face normals for all faces
  bool
  ComputeFaceNormal (int); // computes face normal of indexed face
  ...
  */
  int
  GetClashingFacePairs (int max_pair_count,
  ...
  */
  int
  CullClashingFaces (int what_to_cull);

  int
  CullDegenerateFaces (); // returns number of degenerate faces

  int
  CullUnusedVertices (); // returns number of culled vertices
  ...
  bool
  ComputeVertexNormals (); // uses face normals to cook up a vertex normal
  ...
  //			true  -  success
  bool
  ReverseTextureCoordinates (int dir);
  bool
  ReverseSurfaceParameters (int dir);
  ...
  */
  ...
  CachedTextureCoordinates (const ON_UUID& mapping_id) const;
  ...
  bool
  CombineCoincidentVertices (ON_3fVector, // coordinate tols for considering vertices
                                          // to be coincident
  ...
  */
  bool
  CombineIdenticalVertices (bool bIgnoreVertexNormals = false,
                            bool bIgnoreTextureCoordinates = false);

  void
  Append (const ON_Mesh&); // appends a copy of mesh to this and updates
  ...
  */
  void
  Append (int count, const ON_Mesh* const* meshes);
  ...
  */
  void
  SetSolidOrientation (int solid_orientation);
  ...
  */
  int
  GetMeshEdges (ON_SimpleArray<ON_2dex>& edges) const;
  ...
  */
  int*
  GetVertexLocationIds (int first_vid, int* Vid, int* Vindex) const;
  ...
  */
  int
  GetMeshFaceSideList (const int* Vid, struct ON_MeshFaceSide*& sides) const;
  ...
  */
  int
  GetMeshEdgeList (ON_SimpleArray<ON_2dex>& edge_list,
  ...
  */
  void
  SetVertexHiddenFlag (int meshvi, bool bHidden);
  ...
  */
  bool
  VertexIsHidden (int meshvi) const;
  ...
  */
  ...
  CreatePartition (int, // maximum number of vertices in a partition
  ...
  */
  ON_Mesh*
  MeshPart (const ON_MeshPart& mesh_part, ON_Mesh* mesh) const;
  ...
  */
  ON_Mesh*
  DuplicateFace (int face_index, ON_Mesh* mesh) const;
  ...
  */
  bool
  HasSynchronizedDoubleAndSinglePrecisionVertices () const;
  ...
  */
  bool
  HasDoublePrecisionVertices () const;
  ...
  */
  void
  EnableDoublePrecisionVertices (bool bEnableDoublePrecisionVertices);
  ...
  */
  bool
  SinglePrecisionVerticesAreValid () const;
  ...
  */
  bool
  DoublePrecisionVerticesAreValid () const;
  ...
  */
  bool
  HasPackedTextureRegion () const;

  /////////////////////////////////////////////////////////////////
  // Implementation - curvature

  ON_SimpleArray<ON_SurfaceCurvature> m_K; // OPTIONAL surface curvatures
                                           // Either m_K[] has zero count or it has the
                                           // same count as m_V[], in which case m_K[j]
                                           // reports the surface curvatures at m_V[j].
...
protected:
  ...
  ON_MeshParameters*
      m_mesh_parameters; // If mesh was created from a parametric surface,
...
private:
  char m_mesh_is_closed; // 0 = unset, 1 = all edges have 2 or more faces, 2 = at least
                         // one boundary edge
  char m_mesh_is_manifold; // 0 = unset, 1 = all edges have 1 or 2 faces, 2 = not
                           // manifold
  char m_mesh_is_oriented; // 0 = unset, 1 = faces normals agree across all edges that
                           // have 2 faces, 2 = not oriented
  char m_mesh_is_solid;    // 0 = unset, 1 = solid with outward face normals, 2 = solid
                           // with inward face normals, 3 = not solid
...
private:
  bool
  Write_1 (ON_BinaryArchive&) const; // uncompressed 1.x format
  bool
  Write_2 (int, ON_BinaryArchive&) const; // compressed 2.x format
  bool
  Read_1 (ON_BinaryArchive&);
  bool
  Read_2 (int, ON_BinaryArchive&);
  bool
  WriteFaceArray (int, int, ON_BinaryArchive&) const;
  bool
  ReadFaceArray (int, int, ON_BinaryArchive&);
  bool
  SwapEdge_Helper (int, bool);
};
