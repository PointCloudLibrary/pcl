...
public:
  ...
  */
  ...
  New ();
  static ON_RevSurface*
  New (const ON_RevSurface& rev_surface);
  ...
  ON_BOOL32
  SetAngleRadians (double start_angle_radians, double end_angle_radians);

  ON_BOOL32
  SetAngleDegrees (double start_angle_degrees, double end_angle_degrees);
  ...
  */
  ON_BOOL32
  IsSpherical (ON_Sphere* sphere = NULL, double tolerance = ON_ZERO_TOLERANCE) const;
  ...
  */
  ON_BOOL32
  IsCylindrical (ON_Cylinder* cylinder = NULL,
  ...
  */
  ON_BOOL32
  IsConical (ON_Cone* cone = NULL, double tolerance = ON_ZERO_TOLERANCE) const;
