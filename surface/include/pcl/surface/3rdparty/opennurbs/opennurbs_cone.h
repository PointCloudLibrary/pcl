...
public:
  ...
  ON_BOOL32
  Create (const ON_Plane& plane, double height, double radius);
  ...
  ON_3dPoint
  PointAt (double radial_parameter, double height_parameter) const;
  ...
  ON_3dVector
  NormalAt (double radial_parameter, double height_parameter) const;
  ...
  //   height_parameter - [in] 0 = apex, height = base
  ON_Circle
  CircleAt (double height_parameter) const;
  ...
  //   radial_parameter - [in] (in radians) 0.0 to 2.0*ON_PI
  ON_Line
  LineAt (double radial_parameter) const;
