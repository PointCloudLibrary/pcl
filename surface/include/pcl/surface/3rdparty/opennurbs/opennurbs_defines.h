...
public:
  ...
  */
  ...
  static int
  CloseAllFiles (); // like _fcloseall() - needed when OpenNURBS is used as a DLL
  ...
  */
  static bool
  IsDirectory (const wchar_t* pathname);
  static bool
  IsDirectory (const char* utf8pathname);
  ...
  */
  static int
  IsOpenNURBSFile (const wchar_t* pathname);
  static int
  IsOpenNURBSFile (const char* utf8pathname);
  static int
  IsOpenNURBSFile (FILE* fp);
  ...
  static eAnnotationType
  AnnotationType (int); // convert integer to eAnnotationType enum
  ...
  static active_space
  ActiveSpace (int); // convert integer to active_space enum
  ...
  enum unit_system {
    ...
    // Custom unit systems
    custom_unit_system =
        11 // x meters with x defined in ON_3dmUnitsAndTolerances.m_custom_unit_scale
  };

  static unit_system
  UnitSystem (int); // convert integer to unit_system enum
  ...
  */
  static double
  UnitScale (ON::unit_system us_from, ON::unit_system us_to);
  static double
  UnitScale (const class ON_UnitSystem& us_from, const class ON_UnitSystem& us_to);
  static double
  UnitScale (ON::unit_system us_from, const class ON_UnitSystem& us_to);
  static double
  UnitScale (const class ON_UnitSystem& us_from, ON::unit_system us_to);
  static double
  UnitScale (const class ON_3dmUnitsAndTolerances& us_from,
  ...
  */
  static const wchar_t*
  IsNameReferenceDelimiter (const wchar_t* s);

  //// distance_display_mode ///////////////////////////////////
  enum distance_display_mode { decimal = 0, fractional = 1, feet_inches = 2 };

  static distance_display_mode
  DistanceDisplayMode (int); // convert integer to distance_display_mode enum
  ...
  static point_style
  PointStyle (int); // convert integer to point_style enum
  ...
  {                             // then the style with the lowest value is used
    ...
    clamped_end_knots =
        4, // clamped end knots (with at least 1 interior non-uniform knot)
    non_uniform_knots = 5, // known to be none of the above
    knot_style_count = 6
  };

  static knot_style
  KnotStyle (int); // convert integer to knot_style enum
  ...
  */
  ...
  static curve_style
  CurveStyle (int); // convert integer to curve_style enum
  ...
  enum surface_style {
    ...
    surface_of_revolution =
        8,                 // portion of surface of revolution that is none of the above
  ...
  static surface_style
  SurfaceStyle (int); // convert integer to surface_style enum

  //// sort_algorithm ///////////////////////////////////////////////////////////////
  enum sort_algorithm { heap_sort = 0, quick_sort = 1 };

  static sort_algorithm
  SortAlgorithm (int); // convert integer to sort_method enum

  //// endian-ness ///////////////////////////////////////////////////////////////
  enum endian {
    little_endian =
        0, // least significant byte first or reverse byte order - Intel x86, ...
    big_endian = 1 // most significant byte first - Motorola, Sparc, MIPS, ...
  };

  static endian
  Endian (int); // convert integer to endian enum
  static endian
  Endian (); // returns endian-ness of current CPU
  ...
  static archive_mode
  ArchiveMode (int); // convert integer to endian enum
  ...
  enum view_projection { unknown_view = 0, parallel_view = 1, perspective_view = 2 };
  ...
  */
  static view_projection
  ViewProjection (int i);
  ...
  */
  static bool
  IsPerspectiveProjection (ON::view_projection projection);
  ...
  */
  static bool
  IsParallelProjection (ON::view_projection projection);

  //// view coordinates ///////////////////////////////////////////////////////////

  enum coordinate_system { world_cs = 0, camera_cs = 1, clip_cs = 2, screen_cs = 3 };

  static coordinate_system
  CoordinateSystem (int); // convert integer to coordinate_system enum
  ...
  enum exception_type {
    ...
    unable_to_write_archive, // write operation failed - out of file space/read only
                             // mode/...?
    unable_to_read_archive, // read operation failed - truncated archive/locked file/...
                            // ?
    unable_to_seek_archive, // seek operation failed - locked file/size out of
                            // bounds/... ?
    unexpected_end_of_archive,  // truncated archive
    unexpected_value_in_archive // corrupt archive?
  };
  static exception_type
  ExceptionType (int); // convert integer to exception_type enum
  ...
  static layer_mode
  LayerMode (int); // convert integer to layer_mode enum
  ...
  static object_mode
  ObjectMode (int); // convert integer to object_mode enum
  ...
  enum object_color_source {
    ...
    color_from_parent =
        3 // for objects with parents (like objects in instance references, use parent
          // linetype) if no parent, treat as color_from_layer
  };
  static object_color_source
  ObjectColorSource (int); // convert integer to object_color_source enum
  ...
  enum plot_color_source {
    ...
    plot_color_from_parent =
        3 // for objects with parents (like objects in instance references, use parent
          // plot color) if no parent, treat as plot_color_from_layer
  };
  static plot_color_source
  PlotColorSource (int); // convert integer to plot_color_source enum
  ...
  static plot_weight_source
  PlotWeightSource (int); // convert integer to plot_color_source enum
  ...
  enum object_linetype_source {
    ...
    linetype_from_parent =
        3 // for objects with parents (like objects in instance references, use parent
          // linetype) if not parent, treat as linetype_from_layer.
  };
  static object_linetype_source
  ...
  static object_material_source
  ObjectMaterialSource (int); // convert integer to object_color_source enum
  ...
  enum light_style {
    ...
    camera_point_light =
        5, //   +x points to right, +y points up, +z points towards camera
    camera_spot_light = 6,
  ...
  static light_style
  LightStyle (int); // convert integer to light_style enum
  ...
  static curvature_style
  CurvatureStyle (int); // convert integer to curvature_style enum
  ...
  static display_mode
  DisplayMode (int); // convert integer to display_mode enum
  ...
  static view_type
  ViewType (int); // convert integer to display_mode enum
  ...
  // OBSOLETE
  static texture_mode
  TextureMode (int); // convert integer to texture_mode enum
  // OBSOLETE
  //
  /////////////////////////////////////////////////////////////////////////////
  ...
  enum object_type {
    ...
    surface_object =
        8, // some type of ON_Surface like ON_PlaneSurface, ON_NurbsSurface, etc.
  ...
  static object_type
  ObjectType (int); // convert integer to object_type enum
  ...
  static bitmap_type
  BitmapType (int); // convert integer to bitmap_type enum
  ...
  static object_decoration
  ObjectDecoration (int); // convert integer to line_pattern enum
  ...
  static mesh_type
  MeshType (int); // convert integer to mesh_type enum
  ...
  static osnap_mode
  OSnapMode (int); // convert integer to osnap_mode enum
  ...
  */
  static cubic_loft_end_condition
  CubicLoftEndCondition (int i);
...
public:
  ...
  */
  static int
  Compare (const ON_COMPONENT_INDEX* a, const ON_COMPONENT_INDEX* b);
  ...
  */
  bool
  IsPolyCurveComponentIndex () const;
  ...
  */
  bool
  IsGroupMemberComponentIndex () const;
  ...
  */
  bool
  IsExtrusionProfileComponentIndex () const;
  ...
  */
  bool
  IsExtrusionPathComponentIndex () const;
  ...
  */
  bool
  IsExtrusionWallEdgeComponentIndex () const;
  ...
  */
  bool
  IsExtrusionWallSurfaceComponentIndex () const;
  ...
  */
  bool
  IsExtrusionWallComponentIndex () const;
  ...
  */
  bool
  IsExtrusionComponentIndex () const;
  ...
  */
  bool
  IsPointCloudComponentIndex () const;
  ...
  */
  bool
  IsAnnotationComponentIndex () const;
...
ON_DECL
unsigned int
ON_SetStringConversionWindowsLocaleID (unsigned int locale_id, ON_BOOL32 bWin9X);
...
ON_DECL
int
on_wcsicmp (const wchar_t*, const wchar_t*);
...
ON_DECL
int
on_stricmp (const char*, const char*);
