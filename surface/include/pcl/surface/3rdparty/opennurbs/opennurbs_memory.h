...
ON_DECL
void*
oncalloc_from_pool (ON_MEMORY_POOL*, size_t, size_t);
...
ON_DECL
void*
onrealloc (void*, size_t);

ON_DECL
void*
onrealloc_from_pool (ON_MEMORY_POOL*, void*, size_t);
...
ON_DECL
wchar_t*
onwcsdup (const wchar_t*);
#endif

ON_DECL
unsigned char*
onmbsdup (const unsigned char*);
