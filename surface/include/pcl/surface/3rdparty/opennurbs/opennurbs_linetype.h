...
public:
  ...
  */
  bool
  SetLinetypeName (const char*);
  bool
  SetLinetypeName (const wchar_t*);
  const wchar_t*
  LinetypeName () const;
  ...
  */
  int
  AppendSegment (const ON_LinetypeSegment& segment);
  ...
  */
  bool
  SetSegment (int index, const ON_LinetypeSegment& segment);
  ...
  */
  bool
  SetSegment (int index, double length, ON_LinetypeSegment::eSegType type);
