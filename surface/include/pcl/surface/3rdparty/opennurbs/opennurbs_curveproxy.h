...
public:
  ...
  */
  void
  SetProxyCurve (const ON_Curve* real_curve);
  ...
  */
  void
  SetProxyCurve (const ON_Curve* real_curve, ON_Interval real_curve_subdomain);
  ...
  */
  bool
  SetProxyCurveDomain (ON_Interval proxy_curve_subdomain);
  ...
  */
  double
  RealCurveParameter (double t) const;
  ...
  */
  double
  ThisCurveParameter (double real_curve_parameter) const;
...
private:
  ...
  ON_Interval
  RealCurveInterval (const ON_Interval* sub_domain) const;
...
public:
  ...
  */
  ...
  ON_BOOL32
  Write (               // returns false - nothing serialized
      ON_BinaryArchive& // open binary file
  ) const;

  ON_BOOL32
  Read (                // returns false - nothing serialized
      ON_BinaryArchive& // open binary file
  );
