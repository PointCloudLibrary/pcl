...
public:
  ...
  */
  ...
  ON_BOOL32
  Split (double,     // t = curve parameter to split curve at
  ...
  /*
    ...
    Parameters:
      ...
      index -[out]	index into m_t such that
                    ...
                    if the function returns true then t is equal to, or is closest to
    and within  tolerance of m_t[index].
  ...
  */
  ...
  bool
  Append (const ON_PolylineCurve&);

  /////////////////////////////////////////////////////////////////
  // Interface
public:
  int
  PointCount () const; // number of points in polyline
