...
Details:
  ...
  where xaxis and yaxis, (part of ON_Circle::m_plane) form an othonormal frame of the
...
public:
  ...
  */
  bool
  Create (const ON_Circle& circle, double angle_in_radians);
  ...
  */
  bool
  Create (const ON_Circle& circle, ON_Interval angle_interval_in_radians);
  ...
  */
  bool
  Create (const ON_Plane& plane, double radius, double angle_in_radians);
   ...
   */
  bool
  Create (const ON_3dPoint& center, double radius, double angle_in_radians);
  ...
  */
  ...
  //
  bool
  SetAngleRadians (double angle_in_radians);
  ...
  */
  bool
  SetAngleIntervalRadians (ON_Interval angle_in_radians);
  ...
  //
  bool
  Trim (ON_Interval domain_radian);
  ...
  bool
  SetAngleDegrees (double angle_in_degrees);
  ...
  */
  bool
  GetNurbFormParameterFromRadian (double arc_radians_parameter,
