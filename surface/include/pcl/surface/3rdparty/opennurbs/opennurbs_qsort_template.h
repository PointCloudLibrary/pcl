...
static void
ON_shortsort (ON_SORT_TEMPLATE_TYPE*, ON_SORT_TEMPLATE_TYPE*);
static void
ON_shortsort (ON_SORT_TEMPLATE_TYPE* lo, ON_SORT_TEMPLATE_TYPE* hi)
{
...
#endif
    void
    ON_QSORT_FNAME (ON_SORT_TEMPLATE_TYPE* base, std::size_t num)
{
