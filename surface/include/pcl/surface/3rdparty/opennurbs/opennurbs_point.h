...
public:
  ...
  bool
  operator!=(const ON_Interval&) const;
  bool
  operator==(const ON_Interval&) const;
  ...
  */
  double
  ParameterAt (double normalized_parameter) const;
  ON_Interval
  ParameterAt (ON_Interval normalized_interval) const;
  ...
  */
  double
  NormalizedParameterAt (double interval_parameter) const;
  ON_Interval
  NormalizedParameterAt (ON_Interval interval_parameter) const;

  double&
  operator[](int); // returns (index<=0) ? m_t[0] : m_t[1]
  double
  operator[](int) const; // returns (index<=0) ? m_t[0] : m_t[1]
  double&
  operator[](unsigned int); // returns (index<=0) ? m_t[0] : m_t[1]
  double
  operator[](unsigned int) const; // returns (index<=0) ? m_t[0] : m_t[1]

  double
  Min () const; // returns smaller of m_t[0] and m_t[1]
  double
  Max () const; // returns larger of m_t[0] and m_t[1]
  double
  Mid () const; // returns 0.5*(m_t[0] + m_t[1])
  double
  Length () const;

  bool
  IsIncreasing () const; // returns true if m_t[0] < m_t[1]
  bool
  IsDecreasing () const; // returns true if m_t[0] > m_t[0];
  bool
  IsInterval () const; // returns truc if m_t[0] != m_t[1]
  bool
  IsSingleton () const; // returns true if m_t[0] == m_t[1] != ON_UNSET_VALUE
  bool
  IsEmptyInterval () const; // returns true if m_t[0] == m_t[1] == ON_UNSET_VALUE
  bool
  IsValid () const; // returns ON_IsValid(m_t[0]) && ON_IsValid(m_t[1])

  // OBSOLETE - Use IsEmptyInterval()
  bool
  IsEmptySet () const; // returns true if m_t[0] == m_t[1] == ON_UNSET_VALUE

  bool
  MakeIncreasing (); // returns true if resulting interval IsIncreasing()
  ...
  */
  int
  Compare (const ON_Interval& other) const;
  ...
  */
  bool
  Includes (double t, bool bTestOpenInterval = false) const;
  ...
  */
  bool
  Includes (const ON_Interval& other, bool bProperSubSet = false) const;
  ...
  */
  ...
  bool
  Intersection ( // this = this intersect arg
      const ON_Interval&);
...
public:
  ...
  operator/=(double);
  ON_2dPoint&
  operator+=(const ON_2dPoint&); // Adding this was a mistake - cannot remove without
                                 // breaking SDK
  ON_2dPoint&
  operator+=(const ON_2dVector&);
  ON_2dPoint&
  operator+=(const ON_3dVector&); // Adding this was a mistake - cannot remove without
                                  // breaking SDK
  ON_2dPoint&
  operator-=(const ON_2dPoint&); // Adding this was a mistake - cannot remove without
                                 // breaking SDK
  ...
  double
  operator*(const ON_2dPoint&) const; // dot product for points acting as vectors
  double
  operator*(const ON_2dVector&) const; // dot product for points acting as vectors
  double
  ...
  */
  ...
  double
  DistanceTo (const ON_2dPoint&) const;
  ...
  int
  MinimumCoordinateIndex () const;
  double
  MinimumCoordinate () const; // absolute value of minimum coordinate
...
public:
  ...
  ON_3dPoint&
  operator=(const class ON_2fPoint&);
  ON_3dPoint&
  operator=(const class ON_3fPoint&);
  ON_3dPoint&
  operator=(const class ON_4fPoint&);
  ON_3dPoint&
  operator=(const class ON_2fVector&);
  ON_3dPoint&
  operator=(const class ON_3fVector&);
  ON_3dPoint&
  ...
  operator/=(double);
  ON_3dPoint&
  operator+=(const ON_3dPoint&); // Adding this was a mistake - cannot remove without
                                 // breaking SDK
  ON_3dPoint&
  operator+=(const ON_3dVector&);
  ON_3dPoint&
  ...
  double
  operator*(const ON_3dPoint&) const; // dot product for points acting as vectors
  double
  operator*(const ON_3dVector&) const; // dot product for points acting as vectors
  double
  operator*(const ON_4dPoint&) const;
  ON_3dPoint
  operator*(const ON_Xform&) const;
  ...
  */
  ...
  double
  DistanceTo (const ON_3dPoint&) const;
  ...
  double
  Fuzz (double tolerance =
            ON_ZERO_TOLERANCE) const; // tolerance to use when comparing 3d points
  ...
  void
  Rotate (double angle,            // angle in radians
...
public:
  ...
  operator/=(double);
  ON_4dPoint&
  operator+=(const ON_4dPoint&); // sum w = sqrt(|w1*w2|)
  ON_4dPoint&
  operator-=(const ON_4dPoint&); // difference w = sqrt(|w1*w2|)
  ...
  operator/(double) const;
  ON_4dPoint
  operator+(const ON_4dPoint&) const; // sum w = sqrt(|w1*w2|)
  ON_4dPoint
  operator-(const ON_4dPoint&) const; // difference w = sqrt(|w1*w2|)
...
public:
  ...
  operator=(const ON_3dPoint&);
  ON_2dVector&
  operator=(const double*); // vector = double[2] support
  ...
  operator=(const ON_3fPoint&);
  ON_2dVector&
  operator=(const float*); // vector = float[2] support
  ...
  double
  operator*(const ON_2dPoint&) const; // inner (dot) product (point acting as vector)
  double
  ...
  */
  ...
  IsParallelTo (
      ...
      double angle_tolerance =
          ON_DEFAULT_ANGLE_TOLERANCE // optional angle tolerance (radians)
  ) const;
  ...
  //
  bool
  IsTiny (double tiny_tol = ON_ZERO_TOLERANCE // tiny_tol
  ) const;
  ...
  bool
  PerpendicularTo (const ON_2dPoint&, const ON_2dPoint&);
...
ON_DECL
ON_2dVector
operator*(int, const ON_2dVector&);

ON_DECL
ON_2dVector
operator*(float, const ON_2dVector&);

ON_DECL
ON_2dVector
operator*(double, const ON_2dVector&);
...
ON_DECL
double
ON_DotProduct (const ON_2dVector&, const ON_2dVector&);

ON_DECL
ON_3dVector
ON_CrossProduct (const ON_2dVector&, const ON_2dVector&);
...
public:
  ...
  static const ON_3dVector
      UnsetVector; // (ON_UNSET_VALUE,ON_UNSET_VALUE,ON_UNSET_VALUE)
  ...
  operator=(const ON_3dPoint&);
  ON_3dVector&
  operator=(const double*); // vector = double[3] support
  ...
  operator=(const ON_3fPoint&);
  ON_3dVector&
  operator=(const float*); // vector = float[3] support
  ...
  double
  operator*(const ON_3dPoint&) const; // inner (dot) product
  double
  ...
  */
  ...
  double
  Fuzz (double tolerance =
            ON_ZERO_TOLERANCE) const; // tolerance to use when comparing 3d vectors
  ...
  Unitize (); // returns false if vector has zero length
  double
  LengthAndUnitize (); // unitizes and returns initial length
...
public:
  ...
  static const ON_PlaneEquation
      UnsetPlaneEquation; // (ON_UNSET_VALUE,ON_UNSET_VALUE,ON_UNSET_VALUE,ON_UNSET_VALUE)
  ...
  */
  bool
  Create (ON_3dPoint P, ON_3dVector N);
  ...
  */
  double
  ValueAt (ON_3dPoint P) const;
  double
  ValueAt (ON_4dPoint P) const;
  double
  ValueAt (ON_3dVector P) const;
  double
  ValueAt (double x, double y, double z) const;
  ...
  */
  double*
  ValueAt (int Pcount, const ON_3fPoint* P, double* value, double value_range[2]) const;

  double*
  ValueAt (int Pcount, const ON_3dPoint* P, double* value, double value_range[2]) const;
  ...
  */
  double
  MinimumValueAt (const ON_BoundingBox& bbox) const;
  ...
  */
  double
  MaximumValueAt (const ON_BoundingBox& bbox) const;
...
ON_DECL
ON_3dVector
operator*(int, const ON_3dVector&);

ON_DECL
ON_3dVector
operator*(float, const ON_3dVector&);

ON_DECL
ON_3dVector
operator*(double, const ON_3dVector&);
...
ON_DECL
double
ON_DotProduct (const ON_3dVector&, const ON_3dVector&);

ON_DECL
ON_3dVector
ON_CrossProduct (const ON_3dVector&, const ON_3dVector&);
...
ON_DECL
double
ON_TripleProduct (const ON_3dVector&, const ON_3dVector&, const ON_3dVector&);
...
// ON_UNSET_POINT is OBSOLETE - use ON_3dPoint::UnsetPoint
extern ON_EXTERN_DECL const ON_3dPoint
    ON_UNSET_POINT; // (ON_UNSET_VALUE,ON_UNSET_VALUE,ON_UNSET_VALUE)

// ON_UNSET_VECTOR is OBSOLETE - use ON_3dPoint::UnsetVector
extern ON_EXTERN_DECL const ON_3dVector
    ON_UNSET_VECTOR; // (ON_UNSET_VALUE,ON_UNSET_VALUE,ON_UNSET_VALUE)
