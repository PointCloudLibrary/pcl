...
public:
  ...
  //   side_count < 3.
  bool
  CreateInscribedPolygon (const ON_Circle& circle, int side_count);
  ...
  //   side_count < 3.
  bool
  CreateCircumscribedPolygon (const ON_Circle& circle, int side_count);
  ...
  //   or side_count < 3.
  bool
  CreateStarPolygon (const ON_Circle& circle, double other_radius, int side_count);
  ...
  //   ON_Polyline::Clean.
  bool
  IsValid (double tolerance = 0.0) const;
  ...
  //   points is > tolerance.
  bool
  IsClosed (double tolerance = 0.0) const;
  ...
  ON_3dVector
  SegmentDirection (int segment_index) const;
  ...
  ON_3dVector
  SegmentTangent (int segment_index) const;
