...
public:
  ...
  void
  Evaluate (double s, double t, int der_count, double* value) const;
  ...
  void
  EvaluateHelperLinearBump (double t, double dt, int der_count, double* value) const;
  void
  EvaluateHelperQuinticBump (double t, double dt, int der_count, double* value) const;
};
...
public:
  ...
  */
  bool
  SetBaseSurface (const ON_Surface* srf);
  ...
  */
  bool
  SetSideTangency (int side, bool bEnable);
  ...
  */
  bool
  SetOffsetPoint (double s, double t, double distance, double radius = 0.0);
  ...
  */
  bool
  SetPoint (int index, double s, double t);
  ...
  */
  ON_2dPoint
  OffsetSurfaceParameter (int i) const;
  ...
  */
  double
  DistanceAt (double s, double t) const;
  ...
  */
  bool
  EvaluateDistance (double s, double t, int num_der, double* value) const;
...
public:
  ...
  */
  bool
  SetBaseSurface (const ON_Surface* base_surface);
  ...
  */
  bool
  SetBaseSurface (ON_Surface* base_surface, bool bManage);
  ...
  */
  ...
  ON_OffsetSurfaceFunction&
  OffsetFunction ();
  const ON_OffsetSurfaceFunction&
  OffsetFunction () const;
