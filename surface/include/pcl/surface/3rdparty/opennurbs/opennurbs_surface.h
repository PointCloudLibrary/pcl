...
public:
  ...
  */
  bool
  IsSphere (ON_Sphere* sphere = NULL, double tolerance = ON_ZERO_TOLERANCE) const;
  ...
  */
  bool
  IsCylinder (ON_Cylinder* cylinder = NULL, double tolerance = ON_ZERO_TOLERANCE) const;
  ...
  */
  bool
  IsCone (ON_Cone* cone = NULL, double tolerance = ON_ZERO_TOLERANCE) const;
  ...
  */
  bool
  IsTorus (ON_Torus* torus = NULL, double tolerance = ON_ZERO_TOLERANCE) const;
  ...
  virtual ON_BOOL32
  IsPeriodic ( // true if surface is periodic in direction (default is false)
      int      // dir  0 = "s", 1 = "t"
  ) const;
  ...
  */
  bool
  IsAtSingularity (double s, double t, bool bExact = true) const;
  ...
  */
  int
  IsAtSeam (double s, double t) const;
  ...
  */
  ...
  virtual ON_BOOL32
  Transpose () = 0; // transpose surface parameterization (swap "s" and "t")

  // simple evaluation interface - no error handling
  ON_3dPoint
  PointAt (double, double) const;
  ON_3dVector
  NormalAt (double, double) const;
  ON_BOOL32
...
public:
  ...
  void
  Destroy (); // deletes surfaces in array and sets count to 0

  ON_BOOL32
  Duplicate (ON_SurfaceArray&) const; // operator= copies the pointer values
