...
public:
  ...
  */
  bool
  IsInstanceDefinitionObject () const;
  ...
  */
  ...
  // If PlotColorSource() is ON::plot_color_from_object, then value of PlotColor() is
  // used.
  ...
  Returns:
     ...
     actually modified.
            ...
            0x40: display order
  */
  ON_DEPRECATED unsigned int
  ApplyParentalControl (const ON_3dmObjectAttributes& parent_attributes,
  ...
  */
  bool
  SetCustomRenderMeshParameters (const class ON_MeshParameters& mp);
  ...
  */
  bool
  EnableCustomRenderMeshParameters (bool bEnable);
  ...
  */
  ...
  CustomRenderMeshParameters () const;
  ...
  */
  void
  SetMaterialSource (ON::object_material_source ms);
...
public:
  ...
  // into the array.
  int
  GetGroupList (ON_SimpleArray<int>&) const;
  ...
  */
  bool
  FindDisplayMaterialRef (const ON_DisplayMaterialRef& search_material,
  ...
  */
  bool
  FindDisplayMaterialId (const ON_UUID& viewport_id,
  ...
  */
  bool
  AddDisplayMaterialRef (ON_DisplayMaterialRef display_material);
  ...
  */
  bool
  RemoveDisplayMaterialRef (ON_UUID viewport_id,
                            ON_UUID display_material_id = ON_nil_uuid);
  ...
  */
  int
  DisplayMaterialRefCount () const;

  ON_SimpleArray<ON_DisplayMaterialRef> m_dmref;

private:
  bool
  WriteV5Helper (ON_BinaryArchive& file) const;
  bool
  ReadV5Helper (ON_BinaryArchive& file);
};
