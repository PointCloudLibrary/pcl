...
int
ON_Color::Alpha() const
{
  return (m_color >> 24) & 0xFF;
}

double
ON_Color::FractionRed() const
{
  // return Red()/255.0;
  return (m_color & 0xFF) *
         0.003921568627450980392156862745; // better fodder for optimizer
}

double
ON_Color::FractionGreen() const
{
  // return Green()/255.0;
  return ((m_color >> 8) & 0xFF) *
         0.003921568627450980392156862745; // better fodder for optimizer
