...
ON_OffsetSurface::OffsetFunction()
{
  return m_offset_function;
}

const ON_OffsetSurfaceFunction&
ON_OffsetSurface::OffsetFunction() const
{
  return m_offset_function;
}
...
const ON_Surface*
ON_OffsetSurface::BaseSurface() const
{
  return ProxySurface();
}
...
int
ON_OffsetSurfaceFunction::OffsetPointCount() const
{
...
const ON_Surface*
ON_OffsetSurfaceFunction::BaseSurface() const
{
  return m_srf;
}
...
void
ON_OffsetSurfaceFunction::Destroy()
{
  m_srf = 0;
...
bool
ON_OffsetSurfaceFunction::Initialize()
{
