...
ON__UINT16
ON_CRC16 (ON__UINT16 current_remainder, std::size_t count, const void* p)
{
...
ON__UINT32
ON_CRC32 (ON__UINT32 current_remainder, std::size_t count, const void* p)
{
  /*
  //////////////////////////////////////////////////////////////////////////////////////////
  //
  ...
  */
  ...
  if (count > 0 && p) {
    ...
    while (count >= 8) {
      // while() loop unrolled for speed
      current_remainder =
          ON_CRC32_ZLIB_TABLE[((int)current_remainder ^ (*b++)) & 0xff] ^
          (current_remainder >> 8);
      current_remainder =
          ON_CRC32_ZLIB_TABLE[((int)current_remainder ^ (*b++)) & 0xff] ^
          (current_remainder >> 8);
