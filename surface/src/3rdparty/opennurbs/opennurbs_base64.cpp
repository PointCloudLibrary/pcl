...
ON_DecodeBase64::ON_DecodeBase64() { Begin(); }

ON_DecodeBase64::~ON_DecodeBase64() { Begin(); }

void
ON_DecodeBase64::Begin()
{
  m_decode_count = 0;
  m_output_count = 0;
...
bool
ON_DecodeBase64::Error() const
{
  return (1 == m_status);
}

void
ON_DecodeBase64::DecodeHelper1()
{
...
static void
EncodeBase64Helper1 (const unsigned char* inbuf, char* outbuf)
{
  // base64 encode the final byte of input into 4 bytes of outbuf.
  unsigned char c;
...
static void
EncodeBase64Helper2 (const unsigned char* inbuf, char* outbuf)
{
  // base64 encode the final 2 bytes of input into 4 bytes of outbuf.
  unsigned char b, c;
...
static void
EncodeBase64Helper3 (const unsigned char* inbuf, char* outbuf)
{
  // base64 encode 3 bytes from inbuf into 4 bytes of outbuf.
  unsigned char b, c;
...
static void
EncodeBase64Helper57 (const unsigned char* inbuf, char* outbuf)
{
  // base64 encode 57 bytes from inbuf and put results in m_output[]
  //
  // Encoding 57 input bytes creates 76 output bytes and 76
...
ON_Base64EncodeStream::CallbackFunction() const
{
  return m_out_callback_function;
}

void*
ON_Base64EncodeStream::CallbackContext() const
{
