...
ON_BOOL32
ON_Surface::IsPlanar(ON_Plane*, double) const
{
  return false;
}
...
ON_BOOL32
ON_Surface::IsPeriodic(int) const
{
  return false;
}
...
// virtual
ON_BOOL32
ON_Surface::Trim(int, const ON_Interval&)
{
  return false;
}
...
// virtual
ON_BOOL32
ON_Surface::Split(int, double, ON_Surface*&, ON_Surface*&) const
{
  return false;
}
