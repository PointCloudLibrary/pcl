...
void
ON_DetailView::MemoryRelocate()
{
  m_boundary.MemoryRelocate();
}

ON_BOOL32
ON_DetailView::IsValid (ON_TextLog* text_log) const
{
...
void
ON_DetailView::Dump (ON_TextLog& text_log) const
{
...
ON_BOOL32
ON_DetailView::Write (ON_BinaryArchive& archive) const
{
...
ON_BOOL32
ON_DetailView::Read (ON_BinaryArchive& archive)
{
...
ON::object_type
ON_DetailView::ObjectType() const
{
  return ON::detail_object;
}

int
ON_DetailView::Dimension() const
{
  return m_boundary.Dimension();
}

ON_BOOL32
ON_DetailView::GetBBox (double* boxmin, double* boxmax, int bGrowBox) const
{
...
ON_BOOL32
ON_DetailView::Transform (const ON_Xform& xform)
{
