...
#if defined(ON_OS_WINDOWS_GDI)
static int CALLBACK
ON__IsSymbolFontFaceNameHelper (ENUMLOGFONTEX*, NEWTEXTMETRICEX*, DWORD, LPARAM)
{
...
int
ON_Font::FontIndex() const
{
  return m_font_index;
}

double
ON_Font::LinefeedRatio() const
{
...
void
ON_Font::UpdateImplementationSettings()
{
#if defined(ON_OS_WINDOWS_GDI)
  BYTE b;
  LONG w;
