...
ON_NurbsCage::DataCRC (ON__UINT32 current_remainder) const
{
  ...
  current_remainder =
      ON_CRC32 (current_remainder, 3 * sizeof (m_order[0]), &m_order[0]);
  current_remainder =
                      ...
                      int cv_count2)
{
  ...
  if (2 == cv_count0 && 2 == cv_count1 && 2 == cv_count2) {
    ...
    double* g0 = (double*)onmalloc (m_cv_count[0] * m_cv_count[1] * m_cv_count[2] *
                                    sizeof (*g0));
  ...
  if (!IsRational()) {
    ...
    if (m_cv_count[0] > 0 && m_cv_count[1] > 0 && m_cv_count[2] > 0 && dim > 0) {
      ...
      if (m_cv_stride[0] <= dim || m_cv_stride[1] <= dim || m_cv_stride[2] <= dim) {
        ...
        // strides
        double* new_cv =
            (double*)onmalloc (m_cv_count[0] * m_cv_count[1] * m_cv_count[2] *
                               (dim + 1) * sizeof (*new_cv));
        double* cv1 = new_cv;
