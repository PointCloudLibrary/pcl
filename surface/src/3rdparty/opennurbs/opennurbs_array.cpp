...
ON_2dPointArray::ON_2dPointArray(int c) : ON_SimpleArray<ON_2dPoint>(c) {}
...
bool
ON_2dPointArray::Transform(const ON_Xform& xform)
{
  return ON_TransformPointList(2, false, Count(), 2, (m_a) ? &m_a[0].x : 0, xform);
}

bool
ON_2dPointArray::SwapCoordinates(int i, int j)
{
  return ON_SwapPointListCoordinates(Count(), 2, (m_a) ? &m_a[0].x : 0, i, j);
}

ON_2dPointArray&
ON_2dPointArray::operator=(const ON_2dPointArray& src)
{
  if (this != &src) {
...
ON_3dPointArray::ON_3dPointArray(const ON_SimpleArray<ON_3fPoint>& src) { *this = src; }

ON_BoundingBox
ON_3dPointArray::BoundingBox() const
{
  ON_BoundingBox bbox;
  GetBoundingBox(bbox);
  return bbox;
...
bool
ON_3dPointArray::GetBoundingBox(ON_BoundingBox& bbox, int bGrowBox) const
{
...
bool
ON_3dPointArray::Transform(const ON_Xform& xform)
{
  return ON_TransformPointList(3, false, Count(), 3, (m_a) ? &m_a[0].x : 0, xform);
}

bool
ON_3dPointArray::SwapCoordinates(int i, int j)
{
...
bool
ON_3dPointArray::Translate(const ON_3dVector& delta)
{
  int i;
  for (i = 0; i < m_count; i++)
    m_a[i] += delta;
...
ON_3dPointArray&
ON_3dPointArray::operator=(const ON_3dPointArray& src)
{
  if (this != &src) {
...
ON_3dPointArray&
ON_3dPointArray::operator=(const ON_SimpleArray<ON_3fPoint>& src)
{
...
: ON_SimpleArray<ON_4dPoint>(src)
{}

bool
ON_4dPointArray::Transform(const ON_Xform& xform)
{
  return ON_TransformPointList(3, true, Count(), 4, (m_a) ? &m_a[0].x : 0, xform);
}

bool
ON_4dPointArray::SwapCoordinates(int i, int j)
{
  return ON_SwapPointListCoordinates(Count(), 4, (m_a) ? &m_a[0].x : 0, i, j);
}

ON_4dPointArray&
ON_4dPointArray::operator=(const ON_4dPointArray& src)
{
  if (this != &src) {
...
: ON_SimpleArray<ON_2dVector>(src)
{}
...
bool
ON_2dVectorArray::Transform(const ON_Xform& xform)
{
  return ON_TransformPointList(2, false, Count(), 2, (m_a) ? &m_a[0].x : 0, xform);
}

bool
ON_2dVectorArray::SwapCoordinates(int i, int j)
{
  return ON_SwapPointListCoordinates(Count(), 2, (m_a) ? &m_a[0].x : 0, i, j);
}

ON_2dVectorArray&
ON_2dVectorArray::operator=(const ON_2dVectorArray& src)
{
  if (this != &src) {
...
: ON_SimpleArray<ON_3dVector>(src)
{}
...
bool
ON_3dVectorArray::Transform(const ON_Xform& xform)
{
  return ON_TransformPointList(3, false, Count(), 3, (m_a) ? &m_a[0].x : 0, xform);
}

bool
ON_3dVectorArray::SwapCoordinates(int i, int j)
{
  return ON_SwapPointListCoordinates(Count(), 3, (m_a) ? &m_a[0].x : 0, i, j);
}

ON_3dVectorArray&
ON_3dVectorArray::operator=(const ON_3dVectorArray& src)
{
  if (this != &src) {
...
ON_2fPointArray::ON_2fPointArray(int c) : ON_SimpleArray<ON_2fPoint>(c) {}
...
bool
ON_2fPointArray::Transform(const ON_Xform& xform)
{
  return ON_TransformPointList(2, false, Count(), 2, (m_a) ? &m_a[0].x : 0, xform);
}

bool
ON_2fPointArray::SwapCoordinates(int i, int j)
{
  return ON_SwapPointListCoordinates(Count(), 2, (m_a) ? &m_a[0].x : 0, i, j);
}

ON_2fPointArray&
ON_2fPointArray::operator=(const ON_2fPointArray& src)
{
  if (this != &src) {
...
bool
ON_3fPointArray::Transform(const ON_Xform& xform)
{
  return ON_TransformPointList(3, false, Count(), 3, (m_a) ? &m_a[0].x : 0, xform);
}

bool
ON_3fPointArray::SwapCoordinates(int i, int j)
{
  return ON_SwapPointListCoordinates(Count(), 3, (m_a) ? &m_a[0].x : 0, i, j);
}

ON_3fPointArray&
ON_3fPointArray::operator=(const ON_3fPointArray& src)
{
  if (this != &src) {
...
: ON_SimpleArray<ON_4fPoint>(src)
{}

bool
ON_4fPointArray::Transform(const ON_Xform& xform)
{
  return ON_TransformPointList(3, true, Count(), 4, (m_a) ? &m_a[0].x : 0, xform);
}

bool
ON_4fPointArray::SwapCoordinates(int i, int j)
{
  return ON_SwapPointListCoordinates(Count(), 4, (m_a) ? &m_a[0].x : 0, i, j);
}

ON_4fPointArray&
ON_4fPointArray::operator=(const ON_4fPointArray& src)
{
  if (this != &src) {
...
ON_2fVectorArray::ON_2fVectorArray(const ON_2fVectorArray& src)
: ON_SimpleArray<ON_2fVector>(src)
{}
...
bool
ON_2fVectorArray::Transform(const ON_Xform& xform)
{
  return ON_TransformPointList(2, false, Count(), 2, (m_a) ? &m_a[0].x : 0, xform);
}

bool
ON_2fVectorArray::SwapCoordinates(int i, int j)
{
  return ON_SwapPointListCoordinates(Count(), 2, (m_a) ? &m_a[0].x : 0, i, j);
}

ON_2fVectorArray&
ON_2fVectorArray::operator=(const ON_2fVectorArray& src)
{
  if (this != &src) {
...
: ON_SimpleArray<ON_3fVector>(src)
{}
...
bool
ON_3fVectorArray::Transform(const ON_Xform& xform)
{
  return ON_TransformPointList(3, false, Count(), 3, (m_a) ? &m_a[0].x : 0, xform);
}

bool
ON_3fVectorArray::SwapCoordinates(int i, int j)
{
  return ON_SwapPointListCoordinates(Count(), 3, (m_a) ? &m_a[0].x : 0, i, j);
}

ON_3fVectorArray&
ON_3fVectorArray::operator=(const ON_3fVectorArray& src)
{
  if (this != &src) {
...
ON_UuidPair::ON_UuidPair() { memset(this, 0, sizeof(*this)); }

int
ON_UuidPair::CompareFirstUuid(const class ON_UuidPair* a, const class ON_UuidPair* b)
{
  if (!a) {
    return (b) ? -1 : 0;
  }
...
int
ON_UuidPair::CompareSecondUuid(const class ON_UuidPair* a, const class ON_UuidPair* b)
{
  if (!a) {
    return (b) ? -1 : 0;
  }
...
int
ON_UuidPair::Compare(const class ON_UuidPair* a, const class ON_UuidPair* b)
{
  int i;
  if (!a) {
    return (b) ? -1 : 0;
...
: ON_SimpleArray<ON_UUID>(32), m_sorted_count(0), m_removed_count(0)
{}

ON_UuidList::ON_UuidList(int capacity)
: ON_SimpleArray<ON_UUID>(capacity), m_sorted_count(0), m_removed_count(0)
{}
...
bool
ON_UuidList::AddUuid(ON_UUID uuid, bool bCheckForDupicates)
{
...
int
ON_UuidList::Count() const
{
  return m_count - m_removed_count;
}

int
ON_UuidList::CompareUuid(const ON_UUID* a, const ON_UUID* b)
{
  return memcmp(a, b, sizeof(*a));
}

void
ON_UuidList::SortHelper()
{
...
void
ON_UuidList::Reserve(int capacity)
{
  ON_SimpleArray<ON_UUID>::Reserve(capacity);
}

bool
ON_UuidList::RemoveUuid(ON_UUID uuid)
{
...
bool
ON_UuidList::Write(class ON_BinaryArchive& archive) const
{
...
bool
ON_UuidList::Read(class ON_BinaryArchive& archive)
{
  m_count = 0;
  m_removed_count = 0;
  m_sorted_count = 0;
...
bool
ON_UuidList::FindUuid(ON_UUID uuid) const
{
  return (0 != SearchHelper(&uuid));
}

ON_UUID*
ON_UuidList::SearchHelper(const ON_UUID* uuid) const
{
...
: ON_SimpleArray<ON_UuidIndex>(32), m_sorted_count(0), m_removed_count(0)
{}
...
bool
ON_UuidIndexList::AddUuidIndex(ON_UUID uuid, int index, bool bCheckForDupicates)
{
...
int
ON_UuidIndexList::Count() const
{
  return m_count - m_removed_count;
}

void
ON_UuidIndexList::Empty()
{
  m_count = 0;
  m_sorted_count = 0;
  m_removed_count = 0;
...
void
ON_UuidIndexList::Reserve(int capacity)
{
...
bool
ON_UuidIndexList::RemoveUuid(ON_UUID uuid)
{
...
static int
compar_uuidindex_uuid (const ON_UuidIndex* a, const ON_UuidIndex* b)
{
  return ON_UuidList::CompareUuid(&a->m_id, &b->m_id);
}

bool
ON_UuidIndexList::FindUuid(ON_UUID uuid, int* index) const
{
...
bool
ON_UuidIndexList::FindUuidIndex(ON_UUID uuid, int index) const
{
  const ON_UuidIndex* ui = SearchHelper(&uuid);
  if (ui && index != ui->m_i) {
    ui = 0;
...
: ON_SimpleArray<ON_UuidPair>(32), m_sorted_count(0), m_removed_count(0)
{}
...
bool
ON_UuidPairList::AddPair(ON_UUID id1, ON_UUID id2, bool bCheckForDupicates)
{
...
int
ON_UuidPairList::Count() const
{
  return m_count - m_removed_count;
}

void
ON_UuidPairList::Empty()
{
  m_count = 0;
  m_sorted_count = 0;
  m_removed_count = 0;
...
void
ON_UuidPairList::Reserve(int capacity)
{
  if (m_capacity < capacity)
    SetCapacity(capacity);
}
...
bool
ON_UuidPairList::RemovePair(ON_UUID id1)
{
...
bool
ON_UuidPairList::RemovePair(ON_UUID id1, ON_UUID id2)
{
  ON_UuidPair* p = SearchHelper(&id1);
...
static int
compar_uuidpair_id1 (const ON_UuidPair* a, const ON_UuidPair* b)
{
  return ON_UuidList::CompareUuid(&a->m_uuid[0], &b->m_uuid[0]);
}

static int
compar_uuidpair_id1id2 (const ON_UuidPair* a, const ON_UuidPair* b)
{
  int i;
...
bool
ON_UuidPairList::FindId1(ON_UUID id1, ON_UUID* id2) const
{
...
bool
ON_UuidPairList::FindPair(ON_UUID id1, ON_UUID id2) const
{
  const ON_UuidPair* ui = SearchHelper(&id1);
...
int
ON_UuidPairList::GetId1s(ON_SimpleArray<ON_UUID>& uuid_list) const
{
...
void
ON_UuidPairList::ImproveSearchSpeed()
{
  if (((unsigned int)m_count) > m_sorted_count) {
    ...
    if (m_removed_count > 0) {
      ...
      while (m_count > 0 &&
             !compar_uuidpair_id1id2(&removed_uuid, m_a + (m_count - 1))) {
        m_count--;
      }
      m_removed_count = 0;
    }
...
ON_UuidPair*
ON_UuidPairList::SearchHelper(const ON_UUID* id1) const
{
  if (m_count - m_sorted_count > 8 || m_removed_count > 0) {
    // time to resort the array so that the speedy
    // bsearch() can be used to find uuids
  ...
  // NOTE:
  //   The pair (ON_max_uuid,ON_max_uuid) never appears in the sorted portion of the
  //   array.
...
void
ON_UuidList::RemapUuids(const ON_SimpleArray<ON_UuidPair>& uuid_remap)
{
  if (m_count > 0 && uuid_remap.Count() > 0) {
    bool bRemapped = false;
    int i, j;
    for (i = 0; i < m_count; i++) {
      j = uuid_remap.BinarySearch((const ON_UuidPair*)&m_a[i],
...
int
ON_UuidList::GetUuids(ON_SimpleArray<ON_UUID>& uuid_list) const
{
  const int count0 = uuid_list.Count();
  int i;
  uuid_list.Reserve(uuid_list.Count() + (m_count - m_removed_count));
...
int
ON_UuidIndexList::GetUuids(ON_SimpleArray<ON_UUID>& uuid_list) const
{
  const int count0 = uuid_list.Count();
  int i;
...
void
ON_UuidIndexList::ImproveSearchSpeed()
{
  if (((unsigned int)m_count) > m_sorted_count) {
    ...
    if (m_removed_count > 0) {
      ...
      removed_uuid.m_i = 0;
      while (m_count > 0 &&
             !compar_uuidindex_uuid(&removed_uuid, m_a + (m_count - 1))) {
        m_count--;
      }
      m_removed_count = 0;
    }
...
ON_UuidIndex*
ON_UuidIndexList::SearchHelper(const ON_UUID* uuid) const
{
  if (m_count - m_sorted_count > 8 || m_removed_count > 0) {
    // time to resort the array so that the speedy
    // bsearch() can be used to find uuids
...
ON_2dexMap::ON_2dexMap(int capacity) : ON_SimpleArray<ON_2dex>(capacity), m_bSorted(0)
{}

ON_2dexMap::~ON_2dexMap() {}

int
ON_2dexMap::Count() const
{
  return m_count;
}

const ON_2dex*
ON_2dexMap::Array() const
{
  return m_a;
}

void
ON_2dexMap::Reserve(int capacity)
{
  ON_SimpleArray<ON_2dex>::Reserve(capacity);
}

ON_2dex
ON_2dexMap::operator[](int i) const
{
  return m_a[i];
}

void
ON_2dexMap::Create(int count, int i0, int j)
{
  if (count <= 0) {
    m_count = 0;
  }
...
static int
compare_2dex_i (const void* a, const void* b)
{
...
const ON_2dex*
ON_2dexMap::Find2dex(int i) const
{
  const ON_2dex* e = 0;
  if (m_count > 0) {
    if (!m_bSorted) {
...
int
ON_2dexMap::FindIndex(int i, int not_found_rc) const
{
...
bool
ON_2dexMap::AddIndex(int i, int j)
{
...
bool
ON_2dexMap::SetIndex(int i, int j)
{
...
void
ON_2dexMap::SetOrAddIndex(int i, int j)
{
  ON_2dex* e = const_cast<ON_2dex*>(Find2dex(i));
  if (e) {
    e->j = j;
