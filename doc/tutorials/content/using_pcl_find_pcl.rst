...
Using PCL in your own project with FindPCL.cmake
------------------------------------------------

This tutorial explains how to use PCL from your own project if you
just got it from binaries


Prerequisites
-------------

We assume you have downloaded, and installed PCL on your
machine.
...
FindPCL.cmake can be obtaind from: http://svn.pointclouds.org/pcl/tags/pcl-1.2/doc/tutorials/content/sources/FindPCL.cmake
...
* `PCL_LIBRARY_DIRS`: set to the paths to where PCL libraries reside
