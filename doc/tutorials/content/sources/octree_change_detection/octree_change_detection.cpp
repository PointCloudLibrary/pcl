...
main ()
{
  ...
  // Switch octree buffers: This resets octree but keeps previous tree structure in
  // memory.
  ...
  // Get vector of point indices from octree voxels which did not exist in previous
  // buffer
