...
CloudStyle styleWhite(255.0, 255.0, 255.0, 4.0);
CloudStyle styleRed(255.0, 0.0, 0.0, 3.0);
CloudStyle styleGreen(0.0, 255.0, 0.0, 5.0);
CloudStyle styleCyan(93.0, 200.0, 217.0, 4.0);
CloudStyle styleViolet(255.0, 0.0, 255.0, 8.0);
...
int main(int argc, char *argv[]) {
    ...
    if (show_keypoints_) {
        CloudStyle modelStyle = styleWhite;
    ...
    if (show_keypoints_) {
        CloudStyle goodKeypointStyle = styleViolet;
        pcl::visualization::PointCloudColorHandlerCustom<PointType> model_good_keypoints_color_handler(
                off_model_good_kp,
                goodKeypointStyle.r,
                goodKeypointStyle.g,
                goodKeypointStyle.b);
        ...
        pcl::visualization::PointCloudColorHandlerCustom<PointType> scene_good_keypoints_color_handler(
                scene_good_kp,
                goodKeypointStyle.r,
                goodKeypointStyle.g,
                goodKeypointStyle.b);
    ...
    for (size_t i = 0; i < instances.size(); ++i) {
        ...
        CloudStyle clusterStyle = styleRed;
        ...
        CloudStyle registeredStyles = hypotheses_mask[i] ? styleGreen : styleCyan;
