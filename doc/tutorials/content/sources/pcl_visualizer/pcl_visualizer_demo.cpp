...
boost::shared_ptr<PCLVisualizer> simpleVis(PointCloud<PointXYZ>::ConstPtr cloud)
{
  // --------------------------------------------
...
boost::shared_ptr<PCLVisualizer> normalsVis(PointCloud<PointXYZRGB>::ConstPtr cloud,
...
boost::shared_ptr<PCLVisualizer> shapesVis(PointCloud<PointXYZRGB>::ConstPtr cloud)
{
  // --------------------------------------------
  // -----Open 3D viewer and add point cloud-----
  // --------------------------------------------
  ...
  //------------------------------------
  viewer->addLine<PointXYZRGB> (cloud->points[0],
...
boost::shared_ptr<PCLVisualizer> viewportsVis(PointCloud<PointXYZRGB>::ConstPtr cloud,
        PointCloud<Normal>::ConstPtr normals1, PointCloud<Normal>::ConstPtr normals2)
{
  // --------------------------------------------------------
  // -----Open 3D viewer and add point cloud and normals-----
  // --------------------------------------------------------
...
int main (int argc, char** argv)
{
  ...
  {
    rgb = true;
    cout << "RGB colour visualisation example\n";
  }
  else if (pcl::console::find_argument (argc, argv, "-n") >= 0)
  {
    normals = true;
    cout << "Normals visualisation example\n";
  }
  else if (pcl::console::find_argument (argc, argv, "-a") >= 0)
  {
    shapes = true;
    cout << "Shapes visualisation example\n";
  }
  ...
  for (float z(-1.0); z <= 1.0; z += 0.05)
  {
      for (float angle(0.0); angle <= 360.0; angle += 5.0)
      {
          ...
          basic_point.x = 0.5 * cosf (deg2rad(angle));
          basic_point.y = sinf (deg2rad(angle));
          basic_point.z = z;
