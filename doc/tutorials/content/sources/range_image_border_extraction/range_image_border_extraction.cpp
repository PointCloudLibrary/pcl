...
int main (int argc, char** argv)
{
  ...
  // ----------------------------------
  pcl::PointCloud<PointWithRange>::Ptr border_points_ptr(new pcl::PointCloud<PointWithRange>),
                                       veil_points_ptr(new pcl::PointCloud<PointWithRange>),
                                       shadow_points_ptr(new pcl::PointCloud<PointWithRange>);
  pcl::PointCloud<PointWithRange>& border_points = *border_points_ptr,
  ...
  PointCloudColorHandlerCustom<PointWithRange> border_points_color_handler (border_points_ptr, 0, 255, 0);
  viewer.addPointCloud<PointWithRange> (border_points_ptr, border_points_color_handler, "border points");
  viewer.setPointCloudRenderingProperties (PCL_VISUALIZER_POINT_SIZE, 7, "border points");
  PointCloudColorHandlerCustom<PointWithRange> veil_points_color_handler (veil_points_ptr, 255, 0, 0);
  viewer.addPointCloud<PointWithRange> (veil_points_ptr, veil_points_color_handler, "veil points");
  viewer.setPointCloudRenderingProperties (PCL_VISUALIZER_POINT_SIZE, 7, "veil points");
  PointCloudColorHandlerCustom<PointWithRange> shadow_points_color_handler (shadow_points_ptr, 0, 255, 255);
  viewer.addPointCloud<PointWithRange> (shadow_points_ptr, shadow_points_color_handler, "shadow points");
  viewer.setPointCloudRenderingProperties (PCL_VISUALIZER_POINT_SIZE, 7, "shadow points");
