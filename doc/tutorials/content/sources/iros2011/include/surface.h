...
PointCloudPtr
smoothPointCloud (const PointCloudPtr& /*input*/,
                  float /*radius*/,
...
SurfaceElementsPtr
computeSurfaceElements (const PointCloudPtr& /*input*/,
                        float /*radius*/,
                        int /*polynomial_order*/)
{
...
pcl::PolygonMesh::Ptr
greedyTriangulation (const SurfaceElementsPtr& /*surfels*/,
                     float /*radius*/,
                     float /*mu*/,
...
pcl::PolygonMesh::Ptr
marchingCubesTriangulation (const SurfaceElementsPtr& /*surfels*/,
                            float /*leaf_size*/,
                            float /*iso_level*/)
{
  pcl::PolygonMesh::Ptr output(new pcl::PolygonMesh);
