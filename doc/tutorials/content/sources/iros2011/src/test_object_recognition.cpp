...
//./test_object_recognition /home/aitor/PCL_tutorial_iros/data/minnie/raw_4.pcd
//--objects_root_path /home/aitor/PCL_tutorial_iros/data --objects
//../../data/objects.txt --filter ../../params/filter.txt --segment
//../../params/segment.txt --feature ../../params/feature.txt --registration
//../../params/registration.txt
...
main (int argc, char** argv)
{
  if (argc < 3) {
    ...
    pcl::console::print_info("    --objects_root_path root_path ......... Root path to "
                             "append to files in object_files.txt \n");
    pcl::console::print_info("    --objects object_files.txt ......... A list of the "
                             "files to use as exemplars\n");
    pcl::console::print_info("    --filter parameters.txt ............ Threshold, "
                             "downsample, and denoise\n");
    pcl::console::print_info(
        "    --segment parameters.txt  .......... Remove dominant plane and cluster\n");
    pcl::console::print_info("    --feature parameters.txt ........... Compute "
                             "normals, keypoints, and descriptors\n");
    pcl::console::print_info(
        "    --registration parameters.txt ...... Align best fitting model to query\n");
    pcl::console::print_info("  and where the parameters files must contain the "
  ...
  if (pcl::console::parse_argument(argc, argv, "--filter", filter_parameters_file) <
      0) {
  ...
  if (pcl::console::parse_argument(
          argc, argv, "--segment", segmentation_parameters_file) < 0) {
  ...
  if (pcl::console::parse_argument(
          argc, argv, "--feature", feature_estimation_parameters_file) < 0) {
  ...
  if (input_stream.is_open()) {
    ...
    pcl::console::print_info(
        "Failed to open the feature estimation parameters file (%s)\n",
  ...
  if (pcl::console::parse_argument(
          argc, argv, "--registration", registration_parameters_file) < 0) {
