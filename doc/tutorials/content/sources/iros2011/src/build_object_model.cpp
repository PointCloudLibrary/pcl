...
main (int argc, char** argv)
{
  if (argc < 3) {
    ...
    pcl::console::print_info ("Note: The output's base filename must be specified "
                              "without the .pcd extension\n");
    pcl::console::print_info (
        "      Four output files will be created with the following suffixes:\n");
