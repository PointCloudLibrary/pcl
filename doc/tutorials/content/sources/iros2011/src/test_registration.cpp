...
main (int argc, char** argv)
{
  if (argc < 3) {
    ...
    pcl::console::print_info("    -i min_sample_dist,max_dist,nr_iters "
                             "................ Compute initial alignment\n");
    pcl::console::print_info("    -r max_dist,rejection_thresh,tform_eps,max_iters "
                             "............. Refine alignment\n");
    pcl::console::print_info("    -s output.pcd ........................... Save the "
                             "registered and merged clouds\n");
  ...
  if (compute_intial_alignment) {
    ...
    tform = computeInitialAlignment(src_keypoints,
                                    src_descriptors,
                                    tgt_keypoints,
                                    tgt_descriptors,
                                    min_sample_dist,
  ...
  bool refine_alignment =
      pcl::console::parse_argument(argc, argv, "-r", params_string) > 0;
  if (refine_alignment) {
    ...
    tform = refineAlignment(src_points,
                            tgt_points,
                            tform,
  ...
  // Or visualize the result
    ...
    pcl::visualization::PointCloudColorHandlerCustom<PointT> yellow(
        tgt_points, 255, 255, 0);
