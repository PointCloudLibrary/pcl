...
// void
// setViewerPose (pcl::visualization::PCLVisualizer& viewer, const Eigen::Affine3f&
// viewer_pose)
//{
// Eigen::Vector3f pos_vector = viewer_pose * Eigen::Vector3f (0, 0, 0);
// Eigen::Vector3f look_at_vector = viewer_pose.rotation () * Eigen::Vector3f (0, 0, 1)
// + pos_vector; Eigen::Vector3f up_vector = viewer_pose.rotation () * Eigen::Vector3f
// (0, -1, 0); viewer.setCameraPosition (pos_vector[0], pos_vector[1], pos_vector[2],
...
main (int argc, char** argv)
{
  ...
  // PointCloudColorHandlerCustom<PointType> point_cloud_color_handler (point_cloud_ptr,
  // 150, 150, 150); viewer.addPointCloud (point_cloud_ptr, point_cloud_color_handler,
