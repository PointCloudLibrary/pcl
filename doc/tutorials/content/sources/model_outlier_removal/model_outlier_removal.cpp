...
int main ()
{
  ...
  // 1.2 add sphere:
  double rand_x1 = 1; double rand_x2 = 1;
  ...
  sphere_coeff.values[0] = 0; sphere_coeff.values[1] = 0; sphere_coeff.values[2] = 0; 
  ...
  for (size_t i = 0; i < cloud_sphere_filtered->points.size (); ++i)
    std::cout << "    " << cloud_sphere_filtered->points[i].x << " " 
                        << cloud_sphere_filtered->points[i].y << " " 
                        << cloud_sphere_filtered->points[i].z << std::endl;
