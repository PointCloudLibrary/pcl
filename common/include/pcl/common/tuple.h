...
struct filter_tuple_values_impl {
   ...
   *
   * \tparam TupleElements the types of the tuple you want to filter
   * \param std::tuple<TupleElements...> a tuple of the types you want to filter
 ...
 *
 * \tparam Predicate A trait which takes a tuple element type as parameter and defines a
 * static boolean member \p value which dictates whether to filter the tuple element
 * type or not
