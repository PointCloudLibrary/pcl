...
private:
  ...
  bool
  check_inside (int col, int row, int min_col, int max_col, int min_row, int max_row)
  {
...
public:
  using Ptr = shared_ptr<FaceDetectorDataProvider<FeatureType,
                                                  DataSet,
                                                  LabelType,
                                                  ExampleIndex,
                                                  NodeType>>;
  using ConstPtr = shared_ptr<const FaceDetectorDataProvider<FeatureType,
                                                             DataSet,
                                                             LabelType,
                                                             ExampleIndex,
                                                             NodeType>>;
  ...
  void
  setPatchesPerImage (int n)
  {
    patches_per_image_ = n;
  }

  void
  setMinImagesPerBin (int n)
  {
