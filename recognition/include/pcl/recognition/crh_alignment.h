...
public:
   ...
   */
  void
  getTransforms (std::vector<Eigen::Matrix4f,
   ...
   */
  void
  align (pcl::PointCloud<pcl::Histogram<nbins_>>& input_ftt,
   ...
   */
  void
  computeRollAngle (pcl::PointCloud<pcl::Histogram<nbins_>>& input_ftt,
                    pcl::PointCloud<pcl::Histogram<nbins_>>& target_ftt,
                    std::vector<float>& peaks)
  {
